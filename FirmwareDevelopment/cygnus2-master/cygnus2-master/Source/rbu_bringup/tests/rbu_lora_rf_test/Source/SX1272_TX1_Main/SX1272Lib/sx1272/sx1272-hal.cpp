...
SX1272MB2xAS::SX1272MB2xAS( RadioEvents_t *events )
                        #if defined ( TARGET_RBU )
                        :   SX1272( events, SX_MOSI, SX_MISO, SX_SCLK, SX_NSS, SX_RESET, SX_DIO0, SX_DIO1, SX_DIO2, SX_DIO3, SX_DIO4, SX_DIO5 ),
                            TxCtl( ANT_TX_NRX ),
                            RxCtl( ANT_RX_NTX ),
                            AntSwitch( RBU_AntSw ), 
                            Fake( RBU_Fake )
                        #elif defined ( TARGET_NUCLEO_L152RE ) || defined ( TARGET_NUCLEO_L476RG )
