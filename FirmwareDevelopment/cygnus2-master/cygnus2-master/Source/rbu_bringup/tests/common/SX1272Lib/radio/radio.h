...
typedef struct
{
     ...
     */
    void    ( *RxDone )( uint8_t *payload, uint16_t size, int16_t rssi, int8_t snr, uint32_t FeiValue, float ferror );
    /*!
...
public:
    ...
    virtual void SetRxConfig ( RadioModems_t modem, uint32_t bandwidth,
                               ...
                               bool iqInverted, bool rxContinuous, bool rxPacketMode ) = 0;
    ...
    virtual void SetTxConfig( RadioModems_t modem, int8_t power, uint32_t fdev,
                              ...
                              uint8_t hopPeriod, bool iqInverted, uint32_t timeout, bool rxPacketMode ) = 0;
     ...
     */
    virtual void SetContinouousDatabit( bool bitValue ) = 0;
      ...
      */
      virtual void EnableContinouousDatabitToggle( bool value ) = 0;
      ...
      */
      virtual bool ContinouousDatabitToggleEnabled( void ) = 0;
      ...
      */
      virtual int16_t GetFskRSSI( void ) = 0;
      ...
      */
      virtual void ReadAndResetSXDataCounters( uint32_t* zeroCount, uint32_t* oneCount, double* ber  ) = 0;
     ...
     */
    virtual bool GetContinouousDatabit( const bool buffered ) = 0;

    virtual void SetTxCW( uint32_t freq, int8_t power, uint32_t time ) = 0;
    virtual void SetTxContinuousMode( uint32_t freq, int8_t power, uint32_t frequencyDeviation, uint32_t bandwidth, uint32_t dataRate, bool enableSequencer, uint32_t timeout ) = 0;
    virtual void SetRxContinuousMode( uint32_t freq, uint32_t frequencyDeviation, uint32_t bandwidth, uint32_t dataRate, bool use_lora_crc, bool enableSequencer ) = 0;
};
