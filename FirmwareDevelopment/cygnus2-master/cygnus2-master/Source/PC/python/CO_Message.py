...
class FaultId(Enum):
    ...
    typedef enum
    {
       ...
       CO_LOW_MAIN_BATTERY_E          = 0x04u,
       CO_DETECTOR_FAULT_E            = 0x08u,
...
class HeadMessageType(Enum):
    ...
    """
    WRITE_ENABLED = 0
    WRITE_PREALARM_THRESHOLD = 1
    WRITE_ALARM_THRESHOLD = 2
    WRITE_FAULT_THRESHOLD = 3
    WRITE_FLASH_RATE = 4
    WRITE_TONE_SELECTION = 5
    WRITE_TEST_MODE = 6
    READ_ENABLED = 7
    READ_PREALARM_THRESHOLD = 8
    READ_ALARM_THRESHOLD = 9
    READ_FAULT_THRESHOLD = 10
    READ_FLASH_RATE = 11
    READ_TONE_SELECTION = 12
    READ_TEST_MODE = 13
    READ_ANALOGUE_VALUE = 14
    READ_SERIAL_NUMBER = 15
    READ_FIRMWARE_VERSION = 16
    READ_FAULT_TYPE = 17
    EVENT_PREALARM_THRESHOLD_EXCEEDED = 18
    EVENT_ALARM_THRESHOLD_EXCEEDED = 19
    EVENT_FAULT_THRESHOLD_EXCEEDED = 20
    RESET_DEVICE = 21
...
class FrameType(Enum):
    ...
    typedef enum
    {
       ...
       FRAME_TYPE_SET_ADDRESS_E,
       FRAME_TYPE_FIRMWARE_E,
