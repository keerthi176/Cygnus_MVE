...
void SpiInit( Spi_t *obj, PinNames mosi, PinNames miso, PinNames sclk, PinNames nss )
{
    ...
    GpioInit( &obj->Mosi, mosi, PIN_ALTERNATE_FCT_E, PIN_PUSH_PULL_E, PIN_PULL_DOWN_E, GPIO_AF5_SPI1 );
    GpioInit( &obj->Miso, miso, PIN_ALTERNATE_FCT_E, PIN_PUSH_PULL_E, PIN_PULL_DOWN_E, GPIO_AF5_SPI1 );
    GpioInit( &obj->Sclk, sclk, PIN_ALTERNATE_FCT_E, PIN_PUSH_PULL_E, PIN_PULL_DOWN_E, GPIO_AF5_SPI1 );

    if( nss != NC_E )
    {
        GpioInit( &obj->Nss, nss, PIN_ALTERNATE_FCT_E, PIN_PUSH_PULL_E, PIN_PULL_UP_E, GPIO_AF5_SPI1 );
    }
    else
    {
...
//    SpiFrequency( obj, 10000000 ); //5MHz SPI clock
    SpiFrequency( obj, 7000000 ); // 2.5MHz SPI clock
//    SpiFrequency( obj, 4000000 ); // 1.25MHz SPI clock
...
void SpiDeInit( Spi_t *obj )
{
    ...
    GpioInit( &obj->Mosi, obj->Mosi.pin, PIN_OUTPUT_E, PIN_PUSH_PULL_E, PIN_NO_PULL_E, 0 );
    GpioInit( &obj->Miso, obj->Miso.pin, PIN_OUTPUT_E, PIN_PUSH_PULL_E, PIN_PULL_DOWN_E, 0 );
    GpioInit( &obj->Sclk, obj->Sclk.pin, PIN_OUTPUT_E, PIN_PUSH_PULL_E, PIN_NO_PULL_E, 0 );
    GpioInit( &obj->Nss, obj->Nss.pin, PIN_OUTPUT_E, PIN_PUSH_PULL_E, PIN_PULL_UP_E, 1 );
}
...
uint16_t SpiInOut( Spi_t *obj, uint16_t outData )
{
   ...
   *((__IO uint8_t *)&obj->Spi.Instance->DR) = ( uint8_t ) ( outData & 0xFF );
