...
typedef struct
{
     ...
     * \param [IN] freqency_deviation     The frequency deviation given by the radio hardware
     */
    void    ( *RxDone )( uint8_t *payload, uint16_t size, int16_t rssi, int8_t snr, int32_t freqency_deviation );
    /*!
