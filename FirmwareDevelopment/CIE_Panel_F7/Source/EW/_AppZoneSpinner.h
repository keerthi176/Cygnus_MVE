...
#ifndef _AppZoneSpinner_H
#define _AppZoneSpinner_H
...
/* Forward declaration of the class App::ZoneSpinner */
#ifndef _AppZoneSpinner_
  EW_DECLARE_CLASS( AppZoneSpinner )
#define _AppZoneSpinner_
#endif
...
/* Deklaration of class : 'App::ZoneSpinner' */
EW_DEFINE_FIELDS( AppZoneSpinner, CoreGroup )
...
EW_END_OF_FIELDS( AppZoneSpinner )

/* Virtual Method Table (VMT) for the class : 'App::ZoneSpinner' */
EW_DEFINE_METHODS( AppZoneSpinner, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( AppZoneSpinner _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( AppZoneSpinner _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppZoneSpinner )
