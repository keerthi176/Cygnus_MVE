...
#ifndef _AppTestChannelItem_H
#define _AppTestChannelItem_H
...
/* Forward declaration of the class App::TestChannelItem */
#ifndef _AppTestChannelItem_
  EW_DECLARE_CLASS( AppTestChannelItem )
#define _AppTestChannelItem_
#endif
...
/* Deklaration of class : 'App::TestChannelItem' */
EW_DEFINE_FIELDS( AppTestChannelItem, CoreGroup )
  EW_OBJECT  ( ChannelName,     ViewsText )
  EW_OBJECT  ( HorizontalLedValueBar, WidgetSetHorizontalValueBar )
  EW_OBJECT  ( ToggleButton,    WidgetSetToggleButton )
  EW_OBJECT  ( SmallDropDownMenu, AppSmallDropDownMenu )
  ...
  EW_PROPERTY( ChanType,        XEnum )
  EW_PROPERTY( DefaultAction,   XEnum )
  EW_PROPERTY( UnitNum,         XUInt16 )
  EW_PROPERTY( ZoneNum,         XUInt8 )
  EW_PROPERTY( ChanNum,         XUInt8 )
EW_END_OF_FIELDS( AppTestChannelItem )

/* Virtual Method Table (VMT) for the class : 'App::TestChannelItem' */
EW_DEFINE_METHODS( AppTestChannelItem, CoreGroup )
  ...
  EW_METHOD( UpdateViewState,   void )( AppTestChannelItem _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppTestChannelItem )
