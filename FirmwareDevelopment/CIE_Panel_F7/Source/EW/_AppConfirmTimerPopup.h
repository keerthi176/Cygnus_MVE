...
#ifndef _AppConfirmTimerPopup_H
#define _AppConfirmTimerPopup_H
...
/* Forward declaration of the class App::ConfirmTimerPopup */
#ifndef _AppConfirmTimerPopup_
  EW_DECLARE_CLASS( AppConfirmTimerPopup )
#define _AppConfirmTimerPopup_
#endif
...
/* Deklaration of class : 'App::ConfirmTimerPopup' */
EW_DEFINE_FIELDS( AppConfirmTimerPopup, AppPopup )
...
EW_END_OF_FIELDS( AppConfirmTimerPopup )

/* Virtual Method Table (VMT) for the class : 'App::ConfirmTimerPopup' */
EW_DEFINE_METHODS( AppConfirmTimerPopup, AppPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppConfirmTimerPopup )
