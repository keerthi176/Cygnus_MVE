...
#ifndef _AppNewNumberPopup_H
#define _AppNewNumberPopup_H
...
/* Forward declaration of the class App::NewNumberPopup */
#ifndef _AppNewNumberPopup_
  EW_DECLARE_CLASS( AppNewNumberPopup )
#define _AppNewNumberPopup_
#endif
...
/* Deklaration of class : 'App::NewNumberPopup' */
EW_DEFINE_FIELDS( AppNewNumberPopup, AppPopup )
...
EW_END_OF_FIELDS( AppNewNumberPopup )

/* Virtual Method Table (VMT) for the class : 'App::NewNumberPopup' */
EW_DEFINE_METHODS( AppNewNumberPopup, AppPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppNewNumberPopup )
