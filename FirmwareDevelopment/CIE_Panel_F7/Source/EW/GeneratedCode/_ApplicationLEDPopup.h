...
#ifndef _ApplicationLEDPopup_H
#define _ApplicationLEDPopup_H
...
/* Forward declaration of the class Application::LEDPopup */
#ifndef _ApplicationLEDPopup_
  EW_DECLARE_CLASS( ApplicationLEDPopup )
#define _ApplicationLEDPopup_
#endif
...
/* Deklaration of class : 'Application::LEDPopup' */
EW_DEFINE_FIELDS( ApplicationLEDPopup, ApplicationPopup )
  EW_OBJECT  ( ToggleButton,    WidgetSetToggleButton )
  EW_OBJECT  ( PushButton,      WidgetSetPushButton )
  EW_OBJECT  ( Text,            ViewsText )
EW_END_OF_FIELDS( ApplicationLEDPopup )

/* Virtual Method Table (VMT) for the class : 'Application::LEDPopup' */
EW_DEFINE_METHODS( ApplicationLEDPopup, ApplicationPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationLEDPopup )
