...
#ifndef _AppLogPopup_H
#define _AppLogPopup_H
...
/* Forward declaration of the class App::LogPopup */
#ifndef _AppLogPopup_
  EW_DECLARE_CLASS( AppLogPopup )
#define _AppLogPopup_
#endif
...
/* Deklaration of class : 'App::LogPopup' */
EW_DEFINE_FIELDS( AppLogPopup, AppPopup )
...
EW_END_OF_FIELDS( AppLogPopup )

/* Virtual Method Table (VMT) for the class : 'App::LogPopup' */
EW_DEFINE_METHODS( AppLogPopup, AppPopup )
