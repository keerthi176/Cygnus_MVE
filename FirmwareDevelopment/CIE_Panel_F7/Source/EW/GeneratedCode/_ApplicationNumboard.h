...
#ifndef _ApplicationNumboard_H
#define _ApplicationNumboard_H
...
/* Forward declaration of the class Application::Numboard */
#ifndef _ApplicationNumboard_
  EW_DECLARE_CLASS( ApplicationNumboard )
#define _ApplicationNumboard_
#endif
...
/* Deklaration of class : 'Application::Numboard' */
EW_DEFINE_FIELDS( ApplicationNumboard, CoreGroup )
  ...
  EW_OBJECT  ( Key27,           ApplicationKeyLetter )
  EW_OBJECT  ( Key16,           ApplicationKeyLetter )
  EW_OBJECT  ( Key28,           ApplicationKeyLetter )
  EW_OBJECT  ( Key29,           ApplicationKeyLetter )
  EW_OBJECT  ( Key30,           ApplicationKeyLetter )
  EW_OBJECT  ( Touch,           CoreSimpleTouchHandler )
EW_END_OF_FIELDS( ApplicationNumboard )

/* Virtual Method Table (VMT) for the class : 'Application::Numboard' */
EW_DEFINE_METHODS( ApplicationNumboard, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationNumboard _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationNumboard _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationNumboard )
