...
#ifndef _AppTestZoneItem_H
#define _AppTestZoneItem_H
...
/* Forward declaration of the class App::TestZoneItem */
#ifndef _AppTestZoneItem_
  EW_DECLARE_CLASS( AppTestZoneItem )
#define _AppTestZoneItem_
#endif
...
/* Deklaration of class : 'App::TestZoneItem' */
EW_DEFINE_FIELDS( AppTestZoneItem, CoreGroup )
...
EW_END_OF_FIELDS( AppTestZoneItem )

/* Virtual Method Table (VMT) for the class : 'App::TestZoneItem' */
EW_DEFINE_METHODS( AppTestZoneItem, CoreGroup )
  ...
  EW_METHOD( UpdateViewState,   void )( AppTestZoneItem _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppTestZoneItem )
...
/* 'C' function for method : 'App::TestZoneItem.PPUon()' */
void AppTestZoneItem_PPUon( AppTestZoneItem _this, XObject sender );

#ifdef __cplusplus
  }
#endif

#endif /* _AppTestZoneItem_H */
