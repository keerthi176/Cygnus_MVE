...
#ifndef _ApplicationMeshUnit_H
#define _ApplicationMeshUnit_H
...
/* Forward declaration of the class Application::MeshUnit */
#ifndef _ApplicationMeshUnit_
  EW_DECLARE_CLASS( ApplicationMeshUnit )
#define _ApplicationMeshUnit_
#endif
...
/* Deklaration of class : 'Application::MeshUnit' */
EW_DEFINE_FIELDS( ApplicationMeshUnit, CoreGroup )
  EW_OBJECT  ( Text,            ViewsText )
  EW_OBJECT  ( FillPath,        ViewsFillPath )
  EW_OBJECT  ( Path2,           GraphicsPath )
  EW_OBJECT  ( BoxPath,         ViewsStrokePath )
  EW_OBJECT  ( Path1,           GraphicsPath )
  EW_OBJECT  ( AttrSet,         GraphicsAttrSet )
  EW_OBJECT  ( ZoneText,        ViewsText )
  EW_OBJECT  ( ZoneNum,         ViewsText )
  EW_OBJECT  ( ZoneText1,       ViewsText )
  EW_OBJECT  ( UnitNum,         ViewsText )
  EW_OBJECT  ( ZoneText2,       ViewsText )
  EW_OBJECT  ( TypeText,        ViewsText )
  EW_PROPERTY( RadioComb,       XString )
  EW_PROPERTY( DefinedComb,     XString )
  EW_OBJECT  ( Extention,       ViewsText )
  EW_OBJECT  ( Timer,           CoreTimer )
  EW_PROPERTY( Status,          XInt32 )
  EW_PROPERTY( HueRange,        XInt32 )
  EW_PROPERTY( Selected,        XBool )
  EW_PROPERTY( SNR,             XInt8 )
  EW_PROPERTY( Radius1,         XInt8 )
EW_END_OF_FIELDS( ApplicationMeshUnit )

/* Virtual Method Table (VMT) for the class : 'Application::MeshUnit' */
EW_DEFINE_METHODS( ApplicationMeshUnit, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationMeshUnit _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationMeshUnit _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationMeshUnit )
