...
#ifndef _AppSetTimePopup_H
#define _AppSetTimePopup_H
...
/* Forward declaration of the class App::SetTimePopup */
#ifndef _AppSetTimePopup_
  EW_DECLARE_CLASS( AppSetTimePopup )
#define _AppSetTimePopup_
#endif
...
/* Deklaration of class : 'App::SetTimePopup' */
EW_DEFINE_FIELDS( AppSetTimePopup, AppPopup )
  EW_OBJECT  ( TimePicker,      AppTimePicker )
  EW_OBJECT  ( DatePicker,      AppDatePicker )
  EW_OBJECT  ( PushButton,      WidgetSetPushButton )
  EW_OBJECT  ( PushButton1,     WidgetSetPushButton )
EW_END_OF_FIELDS( AppSetTimePopup )

/* Virtual Method Table (VMT) for the class : 'App::SetTimePopup' */
EW_DEFINE_METHODS( AppSetTimePopup, AppPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppSetTimePopup )
