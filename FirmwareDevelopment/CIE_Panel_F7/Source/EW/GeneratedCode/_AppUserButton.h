...
#ifndef _AppUserButton_H
#define _AppUserButton_H
...
/* Forward declaration of the class App::UserButton */
#ifndef _AppUserButton_
  EW_DECLARE_CLASS( AppUserButton )
#define _AppUserButton_
#endif
...
/* Deklaration of class : 'App::UserButton' */
EW_DEFINE_FIELDS( AppUserButton, CoreGroup )
  ...
  EW_PROPERTY( ActionPress,     XSlot )
  EW_PROPERTY( ActionRelease,   XSlot )
  EW_OBJECT  ( Image,           ViewsImage )
  EW_OBJECT  ( Greyed,          ViewsRectangle )
  EW_PROPERTY( ButtonIndex,     XInt32 )
  EW_OBJECT  ( SystemEventHandler, CoreSystemEventHandler )
  EW_OBJECT  ( Text,            ViewsText )
  EW_PROPERTY( Elevation,       XInt8 )
EW_END_OF_FIELDS( AppUserButton )

/* Virtual Method Table (VMT) for the class : 'App::UserButton' */
EW_DEFINE_METHODS( AppUserButton, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( AppUserButton _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( AppUserButton _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppUserButton )
