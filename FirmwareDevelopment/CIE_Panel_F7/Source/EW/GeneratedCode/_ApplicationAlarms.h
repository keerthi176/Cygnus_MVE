...
#ifndef _ApplicationAlarms_H
#define _ApplicationAlarms_H
...
/* Forward declaration of the class Application::Alarms */
#ifndef _ApplicationAlarms_
  EW_DECLARE_CLASS( ApplicationAlarms )
#define _ApplicationAlarms_
#endif
...
/* Deklaration of class : 'Application::Alarms' */
EW_DEFINE_FIELDS( ApplicationAlarms, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationAlarms )

/* Virtual Method Table (VMT) for the class : 'Application::Alarms' */
EW_DEFINE_METHODS( ApplicationAlarms, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationAlarms _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationAlarms _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationAlarms )
