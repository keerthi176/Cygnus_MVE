...
#ifndef _ApplicationCAEComponent_H
#define _ApplicationCAEComponent_H
...
/* Forward declaration of the class Application::CAEComponent */
#ifndef _ApplicationCAEComponent_
  EW_DECLARE_CLASS( ApplicationCAEComponent )
#define _ApplicationCAEComponent_
#endif
...
/* Deklaration of class : 'Application::CAEComponent' */
EW_DEFINE_FIELDS( ApplicationCAEComponent, CoreGroup )
  EW_PROPERTY( CAERoot,         ApplicationCAEModule )
EW_END_OF_FIELDS( ApplicationCAEComponent )

/* Virtual Method Table (VMT) for the class : 'Application::CAEComponent' */
EW_DEFINE_METHODS( ApplicationCAEComponent, CoreGroup )
  EW_METHOD( initLayoutContext, void )( CoreRectView _this, XRect aBounds, CoreOutline 
    aOutline )
  EW_METHOD( GetRoot,           CoreRoot )( CoreView _this )
  EW_METHOD( Draw,              void )( ApplicationCAEComponent _this, GraphicsCanvas 
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationCAEComponent _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationCAEComponent _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationCAEComponent )
...
#endif /* _ApplicationCAEComponent_H */
