...
#ifndef _ApplicationExportConfigPopup_H
#define _ApplicationExportConfigPopup_H
...
/* Forward declaration of the class Application::ExportConfigPopup */
#ifndef _ApplicationExportConfigPopup_
  EW_DECLARE_CLASS( ApplicationExportConfigPopup )
#define _ApplicationExportConfigPopup_
#endif
...
/* Deklaration of class : 'Application::ExportConfigPopup' */
EW_DEFINE_FIELDS( ApplicationExportConfigPopup, ApplicationPopup )
...
EW_END_OF_FIELDS( ApplicationExportConfigPopup )

/* Virtual Method Table (VMT) for the class : 'Application::ExportConfigPopup' */
EW_DEFINE_METHODS( ApplicationExportConfigPopup, ApplicationPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationExportConfigPopup )
...
#endif /* _ApplicationExportConfigPopup_H */
