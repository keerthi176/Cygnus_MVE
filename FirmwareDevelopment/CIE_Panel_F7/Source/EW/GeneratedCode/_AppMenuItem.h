...
#ifndef _AppMenuItem_H
#define _AppMenuItem_H
...
/* Deklaration of class : 'App::MenuItem' */
EW_DEFINE_FIELDS( AppMenuItem, CoreGroup )
...
EW_END_OF_FIELDS( AppMenuItem )

/* Virtual Method Table (VMT) for the class : 'App::MenuItem' */
EW_DEFINE_METHODS( AppMenuItem, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( AppMenuItem _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( AppMenuItem _this, XSet aState )
