...
void AppDeviceClass_TriggerMeshListChangeEvent( AppDeviceClass _this, XInt16 total, 
  XInt16 active, XInt16 formed, XInt16 synced, XInt16 extra );
...
void AppDeviceClass__TriggerMeshListChangeEvent( void* _this, XInt16 total, XInt16 
  active, XInt16 formed, XInt16 synced, XInt16 extra );
...
/* This method is intended to be called by the device to notify the GUI application 
   about a particular system event. */
void AppDeviceClass_TriggerSiteLoadedEvent( AppDeviceClass _this );

/* Wrapper function for the non virtual method : 'App::DeviceClass.TriggerSiteLoadedEvent()' */
void AppDeviceClass__TriggerSiteLoadedEvent( void* _this );

/* The following define announces the presence of the method App::DeviceClass.TriggerSiteLoadedEvent(). */
#define _AppDeviceClass__TriggerSiteLoadedEvent_
