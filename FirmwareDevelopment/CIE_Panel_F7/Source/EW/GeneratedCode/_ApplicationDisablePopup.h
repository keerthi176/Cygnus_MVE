...
#ifndef _ApplicationDisablePopup_H
#define _ApplicationDisablePopup_H
...
/* Forward declaration of the class Application::DisablePopup */
#ifndef _ApplicationDisablePopup_
  EW_DECLARE_CLASS( ApplicationDisablePopup )
#define _ApplicationDisablePopup_
#endif
...
/* Deklaration of class : 'Application::DisablePopup' */
EW_DEFINE_FIELDS( ApplicationDisablePopup, ApplicationPopup )
  EW_OBJECT  ( EnableDisable,   ApplicationEnableDisable )
  EW_OBJECT  ( ActionButton,    FlatActionButton )
  EW_OBJECT  ( ActionButton1,   FlatActionButton )
EW_END_OF_FIELDS( ApplicationDisablePopup )

/* Virtual Method Table (VMT) for the class : 'Application::DisablePopup' */
EW_DEFINE_METHODS( ApplicationDisablePopup, ApplicationPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationDisablePopup )
...
#endif /* _ApplicationDisablePopup_H */
