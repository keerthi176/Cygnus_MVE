...
#ifndef _ApplicationTabButton_H
#define _ApplicationTabButton_H
...
/* Forward declaration of the class Application::TabButton */
#ifndef _ApplicationTabButton_
  EW_DECLARE_CLASS( ApplicationTabButton )
#define _ApplicationTabButton_
#endif
...
/* Deklaration of class : 'Application::TabButton' */
EW_DEFINE_FIELDS( ApplicationTabButton, CoreGroup )
  ...
  EW_PROPERTY( Selected,        XRef )
  EW_PROPERTY( OnDeactivate,    XSlot )
  EW_OBJECT  ( Text2,           ViewsText )
  EW_OBJECT  ( Text1,           ViewsAttrText )
  EW_OBJECT  ( AttrSet1,        GraphicsAttrSet )
  EW_OBJECT  ( Timer,           CoreTimer )
  EW_PROPERTY( NumberOf,        XUInt16 )
  EW_PROPERTY( pressed,         XBool )
EW_END_OF_FIELDS( ApplicationTabButton )

/* Virtual Method Table (VMT) for the class : 'Application::TabButton' */
EW_DEFINE_METHODS( ApplicationTabButton, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationTabButton _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationTabButton _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationTabButton )
