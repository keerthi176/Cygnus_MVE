...
/* Deklaration of class : 'App::Modify' */
EW_DEFINE_FIELDS( AppModify, CoreGroup )
...
EW_END_OF_FIELDS( AppModify )

/* Virtual Method Table (VMT) for the class : 'App::Modify' */
EW_DEFINE_METHODS( AppModify, CoreGroup )
  ...
  EW_METHOD( OnSetVisible,      void )( AppModify _this, XBool value )
  EW_METHOD( DispatchEvent,     XObject )( CoreGroup _this, CoreEvent aEvent )
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( AppModify _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( AppModify _this, XSet aState )
