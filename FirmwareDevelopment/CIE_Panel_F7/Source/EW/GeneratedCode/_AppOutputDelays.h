...
#ifndef _AppOutputDelays_H
#define _AppOutputDelays_H
...
/* Forward declaration of the class App::OutputDelays */
#ifndef _AppOutputDelays_
  EW_DECLARE_CLASS( AppOutputDelays )
#define _AppOutputDelays_
#endif
...
/* Deklaration of class : 'App::OutputDelays' */
EW_DEFINE_FIELDS( AppOutputDelays, CoreGroup )
  ...
  EW_OBJECT  ( globaldelay,     WidgetSetToggleButton )
EW_END_OF_FIELDS( AppOutputDelays )

/* Virtual Method Table (VMT) for the class : 'App::OutputDelays' */
EW_DEFINE_METHODS( AppOutputDelays, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppOutputDelays )
