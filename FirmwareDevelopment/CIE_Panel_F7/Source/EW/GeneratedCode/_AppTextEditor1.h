...
#ifndef _AppTextEditor1_H
#define _AppTextEditor1_H
...
/* Forward declaration of the class App::TextEditor1 */
#ifndef _AppTextEditor1_
  EW_DECLARE_CLASS( AppTextEditor1 )
#define _AppTextEditor1_
#endif
...
EW_DEFINE_FIELDS( AppTextEditor1, TemplatesTextEditor )
...
EW_END_OF_FIELDS( AppTextEditor1 )

/* Virtual Method Table (VMT) for the class : 'App::TextEditor1' */
EW_DEFINE_METHODS( AppTextEditor1, TemplatesTextEditor )
  ...
  EW_METHOD( UpdateViewState,   void )( AppTextEditor1 _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppTextEditor1 )
