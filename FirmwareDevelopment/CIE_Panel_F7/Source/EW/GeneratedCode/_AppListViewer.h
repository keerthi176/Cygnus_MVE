...
#ifndef _AppListViewer_H
#define _AppListViewer_H
...
/* Forward declaration of the class App::ListViewer */
#ifndef _AppListViewer_
  EW_DECLARE_CLASS( AppListViewer )
#define _AppListViewer_
#endif
...
/* Deklaration of class : 'App::ListViewer' */
EW_DEFINE_FIELDS( AppListViewer, CoreGroup )
  ...
  EW_PROPERTY( onRefreshAll,    XSlot )
  EW_OBJECT  ( SimpleTouchHandler, CoreSimpleTouchHandler )
  EW_PROPERTY( onScrollRefresh, XSlot )
EW_END_OF_FIELDS( AppListViewer )

/* Virtual Method Table (VMT) for the class : 'App::ListViewer' */
EW_DEFINE_METHODS( AppListViewer, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( AppListViewer _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( AppListViewer _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppListViewer )
