...
#ifndef _ApplicationDFUPopup_H
#define _ApplicationDFUPopup_H
...
/* Forward declaration of the class Application::DFUPopup */
#ifndef _ApplicationDFUPopup_
  EW_DECLARE_CLASS( ApplicationDFUPopup )
#define _ApplicationDFUPopup_
#endif
...
/* Deklaration of class : 'Application::DFUPopup' */
EW_DEFINE_FIELDS( ApplicationDFUPopup, ApplicationPopup )
  EW_OBJECT  ( HorizontalValueBar, WidgetSetHorizontalValueBar )
  EW_OBJECT  ( Text,            ViewsText )
  EW_OBJECT  ( Text1,           ViewsText )
  EW_OBJECT  ( Timer,           CoreTimer )
EW_END_OF_FIELDS( ApplicationDFUPopup )

/* Virtual Method Table (VMT) for the class : 'Application::DFUPopup' */
EW_DEFINE_METHODS( ApplicationDFUPopup, ApplicationPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationDFUPopup )
