...
#ifndef _ApplicationSaveSitePopup_H
#define _ApplicationSaveSitePopup_H
...
/* Forward declaration of the class Application::SaveSitePopup */
#ifndef _ApplicationSaveSitePopup_
  EW_DECLARE_CLASS( ApplicationSaveSitePopup )
#define _ApplicationSaveSitePopup_
#endif
...
/* Deklaration of class : 'Application::SaveSitePopup' */
EW_DEFINE_FIELDS( ApplicationSaveSitePopup, ApplicationPopup )
...
EW_END_OF_FIELDS( ApplicationSaveSitePopup )

/* Virtual Method Table (VMT) for the class : 'Application::SaveSitePopup' */
EW_DEFINE_METHODS( ApplicationSaveSitePopup, ApplicationPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationSaveSitePopup )
...
#endif /* _ApplicationSaveSitePopup_H */
