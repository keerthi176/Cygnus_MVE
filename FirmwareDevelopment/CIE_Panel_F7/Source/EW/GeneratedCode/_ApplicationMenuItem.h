...
#ifndef _ApplicationMenuItem_H
#define _ApplicationMenuItem_H
...
/* Deklaration of class : 'Application::MenuItem' */
EW_DEFINE_FIELDS( ApplicationMenuItem, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationMenuItem )

/* Virtual Method Table (VMT) for the class : 'Application::MenuItem' */
EW_DEFINE_METHODS( ApplicationMenuItem, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationMenuItem _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationMenuItem _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationMenuItem )
