...
#ifndef _ApplicationKey_H
#define _ApplicationKey_H
...
/* Forward declaration of the class Application::Key */
#ifndef _ApplicationKey_
  EW_DECLARE_CLASS( ApplicationKey )
#define _ApplicationKey_
#endif
...
/* Deklaration of class : 'Application::Key' */
EW_DEFINE_FIELDS( ApplicationKey, CoreGroup )
  EW_OBJECT  ( Rectangle,       ViewsRectangle )
  EW_OBJECT  ( Bevel,           ViewsBevel )
  EW_PROPERTY( Pressed,         XBool )
EW_END_OF_FIELDS( ApplicationKey )

/* Virtual Method Table (VMT) for the class : 'Application::Key' */
EW_DEFINE_METHODS( ApplicationKey, CoreGroup )
  ...
  EW_METHOD( UpdateViewState,   void )( ApplicationKey _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
  EW_METHOD( OnSetPressed,      void )( ApplicationKey _this, XBool value )
EW_END_OF_METHODS( ApplicationKey )
