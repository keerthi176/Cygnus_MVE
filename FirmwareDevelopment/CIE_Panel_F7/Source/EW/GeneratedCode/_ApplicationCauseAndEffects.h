...
#ifndef _ApplicationCauseAndEffects_H
#define _ApplicationCauseAndEffects_H
...
/* Forward declaration of the class Application::CauseAndEffects */
#ifndef _ApplicationCauseAndEffects_
  EW_DECLARE_CLASS( ApplicationCauseAndEffects )
#define _ApplicationCauseAndEffects_
#endif
...
/* Deklaration of class : 'Application::CauseAndEffects' */
EW_DEFINE_FIELDS( ApplicationCauseAndEffects, CoreGroup )
  EW_OBJECT  ( Rectangle,       ViewsRectangle )
  EW_OBJECT  ( Outline,         CoreOutline )
  EW_OBJECT  ( CAEComponent,    ApplicationCAEComponent )
...
EW_END_OF_FIELDS( ApplicationCauseAndEffects )

/* Virtual Method Table (VMT) for the class : 'Application::CauseAndEffects' */
EW_DEFINE_METHODS( ApplicationCauseAndEffects, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationCauseAndEffects _this, XPoint 
    aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationCauseAndEffects _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationCauseAndEffects )
...
#endif /* _ApplicationCauseAndEffects_H */
