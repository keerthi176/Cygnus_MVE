...
#ifndef _ApplicationLogPopup_H
#define _ApplicationLogPopup_H
...
/* Forward declaration of the class Application::LogPopup */
#ifndef _ApplicationLogPopup_
  EW_DECLARE_CLASS( ApplicationLogPopup )
#define _ApplicationLogPopup_
#endif
...
/* Deklaration of class : 'Application::LogPopup' */
EW_DEFINE_FIELDS( ApplicationLogPopup, ApplicationPopup )
  ...
  EW_OBJECT  ( Events,          WidgetSetToggleButton )
  EW_OBJECT  ( Faults,          WidgetSetToggleButton )
  EW_OBJECT  ( System,          WidgetSetToggleButton )
  EW_OBJECT  ( Fire,            WidgetSetToggleButton )
  EW_OBJECT  ( Settings,        WidgetSetToggleButton )
  EW_OBJECT  ( Access,          WidgetSetToggleButton )
  EW_OBJECT  ( Testing,         WidgetSetToggleButton )
  EW_OBJECT  ( Misc,            WidgetSetToggleButton )
  EW_PROPERTY( Filter,          XInt32 )
  EW_OBJECT  ( SystemEventHandler2, CoreSystemEventHandler )
EW_END_OF_FIELDS( ApplicationLogPopup )

/* Virtual Method Table (VMT) for the class : 'Application::LogPopup' */
EW_DEFINE_METHODS( ApplicationLogPopup, ApplicationPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationLogPopup )
