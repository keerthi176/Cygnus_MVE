...
#ifndef _XFlatCheckBox_H
#define _XFlatCheckBox_H
...
/* Forward declaration of the class XFlat::CheckBox */
#ifndef _XFlatCheckBox_
  EW_DECLARE_CLASS( XFlatCheckBox )
#define _XFlatCheckBox_
#endif


/* Simple check box widget. The widget is used to switch a boolean value on and 
   off. */
EW_DEFINE_FIELDS( XFlatCheckBox, CoreGroup )
...
EW_END_OF_FIELDS( XFlatCheckBox )

/* Virtual Method Table (VMT) for the class : 'XFlat::CheckBox' */
EW_DEFINE_METHODS( XFlatCheckBox, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( XFlatCheckBox _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( XFlatCheckBox _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( XFlatCheckBox )
