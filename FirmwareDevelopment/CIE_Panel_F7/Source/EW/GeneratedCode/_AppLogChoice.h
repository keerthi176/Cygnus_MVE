...
#ifndef _AppLogChoice_H
#define _AppLogChoice_H
...
/* Forward declaration of the class App::LogChoice */
#ifndef _AppLogChoice_
  EW_DECLARE_CLASS( AppLogChoice )
#define _AppLogChoice_
#endif
...
/* Deklaration of class : 'App::LogChoice' */
EW_DEFINE_FIELDS( AppLogChoice, AppPopup )
...
EW_END_OF_FIELDS( AppLogChoice )

/* Virtual Method Table (VMT) for the class : 'App::LogChoice' */
EW_DEFINE_METHODS( AppLogChoice, AppPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppLogChoice )
