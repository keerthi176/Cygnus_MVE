...
#ifndef _ApplicationDisableUnitItem_H
#define _ApplicationDisableUnitItem_H
...
/* Forward declaration of the class Application::DisableUnitItem */
#ifndef _ApplicationDisableUnitItem_
  EW_DECLARE_CLASS( ApplicationDisableUnitItem )
#define _ApplicationDisableUnitItem_
#endif
...
/* Deklaration of class : 'Application::DisableUnitItem' */
EW_DEFINE_FIELDS( ApplicationDisableUnitItem, CoreGroup )
  ...
  EW_PROPERTY( ActualZone,      XUInt8 )
  EW_PROPERTY( ZoneNum,         XUInt8 )
EW_END_OF_FIELDS( ApplicationDisableUnitItem )

/* Virtual Method Table (VMT) for the class : 'Application::DisableUnitItem' */
EW_DEFINE_METHODS( ApplicationDisableUnitItem, CoreGroup )
  ...
  EW_METHOD( UpdateViewState,   void )( ApplicationDisableUnitItem _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationDisableUnitItem )
...
#endif /* _ApplicationDisableUnitItem_H */
