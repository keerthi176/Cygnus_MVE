...
#ifndef _ApplicationDisable_H
#define _ApplicationDisable_H
...
/* Forward declaration of the class Application::Disable */
#ifndef _ApplicationDisable_
  EW_DECLARE_CLASS( ApplicationDisable )
#define _ApplicationDisable_
#endif
...
/* Deklaration of class : 'Application::Disable' */
EW_DEFINE_FIELDS( ApplicationDisable, CoreGroup )
  ...
  EW_ARRAY   ( deviceInputFlags, XUInt32, [544])
  EW_OBJECT  ( OnTestChangeEventHandler, CoreSystemEventHandler )
  EW_ARRAY   ( deviceOutputFlags, XUInt32, [544])
  EW_ARRAY   ( zoneFlags,       XUInt8, [97])
EW_END_OF_FIELDS( ApplicationDisable )

/* Virtual Method Table (VMT) for the class : 'Application::Disable' */
EW_DEFINE_METHODS( ApplicationDisable, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationDisable _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationDisable _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationDisable )
