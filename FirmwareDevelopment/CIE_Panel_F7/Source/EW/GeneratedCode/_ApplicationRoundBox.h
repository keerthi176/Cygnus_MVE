...
#ifndef _ApplicationRoundBox_H
#define _ApplicationRoundBox_H
...
/* Forward declaration of the class Application::RoundBox */
#ifndef _ApplicationRoundBox_
  EW_DECLARE_CLASS( ApplicationRoundBox )
#define _ApplicationRoundBox_
#endif
...
/* Deklaration of class : 'Application::RoundBox' */
EW_DEFINE_FIELDS( ApplicationRoundBox, CoreGroup )
  ...
  EW_PROPERTY( Radius1,         XInt32 )
  EW_PROPERTY( LineColour,      XColor )
  EW_PROPERTY( FillColour,      XColor )
  EW_OBJECT  ( Text,            ViewsText )
  EW_PROPERTY( Label,           XString )
EW_END_OF_FIELDS( ApplicationRoundBox )

/* Virtual Method Table (VMT) for the class : 'Application::RoundBox' */
EW_DEFINE_METHODS( ApplicationRoundBox, CoreGroup )
  ...
  EW_METHOD( UpdateViewState,   void )( ApplicationRoundBox _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationRoundBox )
