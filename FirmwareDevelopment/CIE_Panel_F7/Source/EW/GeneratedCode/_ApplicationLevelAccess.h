...
#ifndef _ApplicationLevelAccess_H
#define _ApplicationLevelAccess_H
...
/* Forward declaration of the class Application::LevelAccess */
#ifndef _ApplicationLevelAccess_
  EW_DECLARE_CLASS( ApplicationLevelAccess )
#define _ApplicationLevelAccess_
#endif
...
/* Deklaration of class : 'Application::LevelAccess' */
EW_DEFINE_FIELDS( ApplicationLevelAccess, CoreGroup )
  EW_OBJECT  ( LevelText,       ViewsText )
  EW_PROPERTY( Level,           XInt32 )
  EW_OBJECT  ( Timer,           CoreTimer )
  EW_OBJECT  ( AccessEventHandler, CoreSystemEventHandler )
  EW_PROPERTY( KeySwitchOn,     XBool )
EW_END_OF_FIELDS( ApplicationLevelAccess )

/* Virtual Method Table (VMT) for the class : 'Application::LevelAccess' */
EW_DEFINE_METHODS( ApplicationLevelAccess, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationLevelAccess _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationLevelAccess _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationLevelAccess )
...
#endif /* _ApplicationLevelAccess_H */
