...
#ifndef _FlatCheckBox_H
#define _FlatCheckBox_H
...
/* Forward declaration of the class Flat::CheckBox */
#ifndef _FlatCheckBox_
  EW_DECLARE_CLASS( FlatCheckBox )
#define _FlatCheckBox_
#endif
...
/* Check box widget with a flat design. The widget is used to switch a boolean value 
   on and off. */
EW_DEFINE_FIELDS( FlatCheckBox, CoreGroup )
  EW_PROPERTY( OnChange,        XSlot )
  EW_OBJECT  ( TouchHandler,    CoreSimpleTouchHandler )
  EW_OBJECT  ( BoxImage,        ViewsImage )
  EW_OBJECT  ( CheckImage,      ViewsImage )
...
EW_END_OF_FIELDS( FlatCheckBox )

/* Virtual Method Table (VMT) for the class : 'Flat::CheckBox' */
EW_DEFINE_METHODS( FlatCheckBox, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( FlatCheckBox _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( FlatCheckBox _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( FlatCheckBox )
