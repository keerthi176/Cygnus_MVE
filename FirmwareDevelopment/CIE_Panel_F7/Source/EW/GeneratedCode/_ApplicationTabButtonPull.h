...
#ifndef _ApplicationTabButtonPull_H
#define _ApplicationTabButtonPull_H
...
/* Forward declaration of the class Application::MenuItem */
#ifndef _ApplicationMenuItem_
  EW_DECLARE_CLASS( ApplicationMenuItem )
#define _ApplicationMenuItem_
#endif

/* Forward declaration of the class Application::TabButtonPull */
#ifndef _ApplicationTabButtonPull_
  EW_DECLARE_CLASS( ApplicationTabButtonPull )
#define _ApplicationTabButtonPull_
#endif
...
/* Deklaration of class : 'Application::TabButtonPull' */
EW_DEFINE_FIELDS( ApplicationTabButtonPull, CoreGroup )
  ...
  EW_OBJECT  ( Menu,            CoreVerticalList )
  EW_PROPERTY( OnSelectItem,    XSlot )
  EW_OBJECT  ( Text2,           ViewsText )
  EW_VARIABLE( outside1,        CoreSimpleTouchHandler )
  EW_VARIABLE( outside2,        CoreSimpleTouchHandler )
  EW_PROPERTY( pressed,         XBool )
EW_END_OF_FIELDS( ApplicationTabButtonPull )

/* Virtual Method Table (VMT) for the class : 'Application::TabButtonPull' */
EW_DEFINE_METHODS( ApplicationTabButtonPull, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationTabButtonPull _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationTabButtonPull _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationTabButtonPull )
...
#endif /* _ApplicationTabButtonPull_H */
