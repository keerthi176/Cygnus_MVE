...
#ifndef _ApplicationKeypadKey_H
#define _ApplicationKeypadKey_H
...
/* Forward declaration of the class Application::KeypadKey */
#ifndef _ApplicationKeypadKey_
  EW_DECLARE_CLASS( ApplicationKeypadKey )
#define _ApplicationKeypadKey_
#endif
...
/* Deklaration of class : 'Application::KeypadKey' */
EW_DEFINE_FIELDS( ApplicationKeypadKey, CoreGroup )
  EW_OBJECT  ( Rectangle,       ViewsRectangle )
  EW_OBJECT  ( PushButton,      WidgetSetPushButton )
  EW_OBJECT  ( Text,            ViewsText )
  EW_PROPERTY( NumProperty,     XString )
  EW_OBJECT  ( Rectangle2,      ViewsRectangle )
  EW_PROPERTY( UserPress,       XSlot )
EW_END_OF_FIELDS( ApplicationKeypadKey )

/* Virtual Method Table (VMT) for the class : 'Application::KeypadKey' */
EW_DEFINE_METHODS( ApplicationKeypadKey, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationKeypadKey _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationKeypadKey _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationKeypadKey )
