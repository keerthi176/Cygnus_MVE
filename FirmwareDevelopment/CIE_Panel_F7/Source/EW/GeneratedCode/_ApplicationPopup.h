...
#ifndef _ApplicationPopup_H
#define _ApplicationPopup_H
...
/* Deklaration of class : 'Application::Popup' */
EW_DEFINE_FIELDS( ApplicationPopup, CoreGroup )
  ...
  EW_PROPERTY( Parent,          ApplicationPopup )
EW_END_OF_FIELDS( ApplicationPopup )

/* Virtual Method Table (VMT) for the class : 'Application::Popup' */
EW_DEFINE_METHODS( ApplicationPopup, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationPopup )
