...
/* Deklaration of class : 'App::Key' */
EW_DEFINE_FIELDS( AppKey, CoreGroup )
  EW_OBJECT  ( Rectangle,       ViewsRectangle )
  EW_OBJECT  ( Bevel,           ViewsBevel )
  EW_PROPERTY( Pressed,         XBool )
EW_END_OF_FIELDS( AppKey )

/* Virtual Method Table (VMT) for the class : 'App::Key' */
EW_DEFINE_METHODS( AppKey, CoreGroup )
  ...
  EW_METHOD( UpdateViewState,   void )( AppKey _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
  EW_METHOD( OnSetPressed,      void )( AppKey _this, XBool value )
EW_END_OF_METHODS( AppKey )
