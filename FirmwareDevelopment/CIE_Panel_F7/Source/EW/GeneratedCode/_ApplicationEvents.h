...
#ifndef _ApplicationEvents_H
#define _ApplicationEvents_H
...
/* Forward declaration of the class Application::Events */
#ifndef _ApplicationEvents_
  EW_DECLARE_CLASS( ApplicationEvents )
#define _ApplicationEvents_
#endif
...
/* Deklaration of class : 'Application::Events' */
EW_DEFINE_FIELDS( ApplicationEvents, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationEvents )

/* Virtual Method Table (VMT) for the class : 'Application::Events' */
EW_DEFINE_METHODS( ApplicationEvents, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationEvents _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationEvents _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationEvents )
