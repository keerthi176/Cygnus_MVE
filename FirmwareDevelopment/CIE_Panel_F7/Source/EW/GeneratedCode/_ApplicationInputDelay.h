...
#ifndef _ApplicationInputDelay_H
#define _ApplicationInputDelay_H
...
/* Forward declaration of the class Application::InputDelay */
#ifndef _ApplicationInputDelay_
  EW_DECLARE_CLASS( ApplicationInputDelay )
#define _ApplicationInputDelay_
#endif
...
/* Deklaration of class : 'Application::InputDelay' */
EW_DEFINE_FIELDS( ApplicationInputDelay, CoreGroup )
  EW_OBJECT  ( TitleText,       ViewsText )
  EW_OBJECT  ( Line,            ViewsLine )
  EW_OBJECT  ( Text,            ViewsText )
  EW_OBJECT  ( HorzBarSlider,   WidgetSetHorizontalSlider )
  EW_OBJECT  ( DoubleKnock,     WidgetSetRadioButton )
  EW_OBJECT  ( Sustained,       WidgetSetRadioButton )
  EW_PROPERTY( DelayChoice,     XSet )
  EW_PROPERTY( DelaySecs,       XInt32 )
EW_END_OF_FIELDS( ApplicationInputDelay )

/* Virtual Method Table (VMT) for the class : 'Application::InputDelay' */
EW_DEFINE_METHODS( ApplicationInputDelay, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationInputDelay _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationInputDelay _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationInputDelay )
...
#endif /* _ApplicationInputDelay_H */
