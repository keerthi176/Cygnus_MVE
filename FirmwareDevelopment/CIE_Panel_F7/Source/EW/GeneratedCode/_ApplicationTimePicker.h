...
#ifndef _ApplicationTimePicker_H
#define _ApplicationTimePicker_H
...
/* Forward declaration of the class Application::TimePicker */
#ifndef _ApplicationTimePicker_
  EW_DECLARE_CLASS( ApplicationTimePicker )
#define _ApplicationTimePicker_
#endif
...
EW_DEFINE_FIELDS( ApplicationTimePicker, TemplatesPickerControl )
...
EW_END_OF_FIELDS( ApplicationTimePicker )

/* Virtual Method Table (VMT) for the class : 'Application::TimePicker' */
EW_DEFINE_METHODS( ApplicationTimePicker, TemplatesPickerControl )
  ...
  EW_METHOD( UpdateViewState,   void )( ApplicationTimePicker _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationTimePicker )
...
#endif /* _ApplicationTimePicker_H */
