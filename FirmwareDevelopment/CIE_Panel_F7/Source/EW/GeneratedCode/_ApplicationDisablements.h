...
#ifndef _ApplicationDisablements_H
#define _ApplicationDisablements_H
...
/* Forward declaration of the class Application::Disablements */
#ifndef _ApplicationDisablements_
  EW_DECLARE_CLASS( ApplicationDisablements )
#define _ApplicationDisablements_
#endif
...
/* Deklaration of class : 'Application::Disablements' */
EW_DEFINE_FIELDS( ApplicationDisablements, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationDisablements )

/* Virtual Method Table (VMT) for the class : 'Application::Disablements' */
EW_DEFINE_METHODS( ApplicationDisablements, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationDisablements _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationDisablements _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationDisablements )
...
#endif /* _ApplicationDisablements_H */
