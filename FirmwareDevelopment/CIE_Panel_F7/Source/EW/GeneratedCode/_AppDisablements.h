...
#ifndef _AppDisablements_H
#define _AppDisablements_H
...
/* Forward declaration of the class App::Disablements */
#ifndef _AppDisablements_
  EW_DECLARE_CLASS( AppDisablements )
#define _AppDisablements_
#endif
...
/* Deklaration of class : 'App::Disablements' */
EW_DEFINE_FIELDS( AppDisablements, CoreGroup )
  EW_PROPERTY( numZoneDisablements, XInt32 )
  EW_PROPERTY( numDisablements, XInt32 )
  EW_OBJECT  ( TimeChangedEventHandler, CoreSystemEventHandler )
  EW_OBJECT  ( ListViewer,      AppListViewer )
  EW_OBJECT  ( SiteChangedEventHandler, CoreSystemEventHandler )
  EW_OBJECT  ( DisablementsChangeEventHandler, CoreSystemEventHandler )
  EW_PROPERTY( buzzerDisabled,  XInt32 )
  EW_OBJECT  ( MeshListChangeEventHandler, CoreSystemEventHandler )
EW_END_OF_FIELDS( AppDisablements )

/* Virtual Method Table (VMT) for the class : 'App::Disablements' */
EW_DEFINE_METHODS( AppDisablements, CoreGroup )
  ...
  EW_METHOD( OnSetVisible,      void )( AppDisablements _this, XBool value )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppDisablements )
