...
#ifndef _ApplicationZoneToggle_H
#define _ApplicationZoneToggle_H
...
/* Forward declaration of the class Application::ZoneToggle */
#ifndef _ApplicationZoneToggle_
  EW_DECLARE_CLASS( ApplicationZoneToggle )
#define _ApplicationZoneToggle_
#endif
...
/* Deklaration of class : 'Application::ZoneToggle' */
EW_DEFINE_FIELDS( ApplicationZoneToggle, CoreGroup )
  ...
  EW_PROPERTY( isZone,          XBool )
  EW_PROPERTY( isDevice,        XBool )
  EW_PROPERTY( ZoneNum,         XUInt8 )
EW_END_OF_FIELDS( ApplicationZoneToggle )

/* Virtual Method Table (VMT) for the class : 'Application::ZoneToggle' */
EW_DEFINE_METHODS( ApplicationZoneToggle, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationZoneToggle _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationZoneToggle _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationZoneToggle )
...
#endif /* _ApplicationZoneToggle_H */
