...
#ifndef _ApplicationTestUnitItem_H
#define _ApplicationTestUnitItem_H
...
/* Forward declaration of the class Application::TestUnitItem */
#ifndef _ApplicationTestUnitItem_
  EW_DECLARE_CLASS( ApplicationTestUnitItem )
#define _ApplicationTestUnitItem_
#endif
...
/* Deklaration of class : 'Application::TestUnitItem' */
EW_DEFINE_FIELDS( ApplicationTestUnitItem, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationTestUnitItem )

/* Virtual Method Table (VMT) for the class : 'Application::TestUnitItem' */
EW_DEFINE_METHODS( ApplicationTestUnitItem, CoreGroup )
  ...
  EW_METHOD( UpdateViewState,   void )( ApplicationTestUnitItem _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationTestUnitItem )
...
#endif /* _ApplicationTestUnitItem_H */
