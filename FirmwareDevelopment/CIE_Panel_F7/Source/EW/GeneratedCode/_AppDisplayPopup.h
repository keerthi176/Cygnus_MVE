...
#ifndef _AppDisplayPopup_H
#define _AppDisplayPopup_H
...
/* Forward declaration of the class App::DisplayPopup */
#ifndef _AppDisplayPopup_
  EW_DECLARE_CLASS( AppDisplayPopup )
#define _AppDisplayPopup_
#endif
...
/* Deklaration of class : 'App::DisplayPopup' */
EW_DEFINE_FIELDS( AppDisplayPopup, AppPopup )
...
EW_END_OF_FIELDS( AppDisplayPopup )

/* Virtual Method Table (VMT) for the class : 'App::DisplayPopup' */
EW_DEFINE_METHODS( AppDisplayPopup, AppPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppDisplayPopup )
