...
#ifndef _ApplicationProgressPopup_H
#define _ApplicationProgressPopup_H
...
/* Forward declaration of the class Application::ProgressPopup */
#ifndef _ApplicationProgressPopup_
  EW_DECLARE_CLASS( ApplicationProgressPopup )
#define _ApplicationProgressPopup_
#endif
...
/* Deklaration of class : 'Application::ProgressPopup' */
EW_DEFINE_FIELDS( ApplicationProgressPopup, ApplicationPopup )
  ...
  EW_OBJECT  ( EndEventHandler, CoreSystemEventHandler )
EW_END_OF_FIELDS( ApplicationProgressPopup )

/* Virtual Method Table (VMT) for the class : 'Application::ProgressPopup' */
EW_DEFINE_METHODS( ApplicationProgressPopup, ApplicationPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationProgressPopup )
...
#endif /* _ApplicationProgressPopup_H */
