...
#ifndef _ApplicationTestChannelItem_H
#define _ApplicationTestChannelItem_H
...
/* Forward declaration of the class Application::TestChannelItem */
#ifndef _ApplicationTestChannelItem_
  EW_DECLARE_CLASS( ApplicationTestChannelItem )
#define _ApplicationTestChannelItem_
#endif
...
/* Deklaration of class : 'Application::TestChannelItem' */
EW_DEFINE_FIELDS( ApplicationTestChannelItem, CoreGroup )
  ...
  EW_OBJECT  ( SmallDropDownMenu, ApplicationSmallDropDownMenu )
...
EW_END_OF_FIELDS( ApplicationTestChannelItem )

/* Virtual Method Table (VMT) for the class : 'Application::TestChannelItem' */
EW_DEFINE_METHODS( ApplicationTestChannelItem, CoreGroup )
  ...
  EW_METHOD( UpdateViewState,   void )( ApplicationTestChannelItem _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationTestChannelItem )
...
#endif /* _ApplicationTestChannelItem_H */
