...
#ifndef _AppTextPopup_H
#define _AppTextPopup_H
...
/* Forward declaration of the class App::TextPopup */
#ifndef _AppTextPopup_
  EW_DECLARE_CLASS( AppTextPopup )
#define _AppTextPopup_
#endif
...
/* Deklaration of class : 'App::TextPopup' */
EW_DEFINE_FIELDS( AppTextPopup, AppPopup )
  ...
  EW_OBJECT  ( GreyOutRect,     ViewsRectangle )
  EW_PROPERTY( ShowName,        XBool )
EW_END_OF_FIELDS( AppTextPopup )

/* Virtual Method Table (VMT) for the class : 'App::TextPopup' */
EW_DEFINE_METHODS( AppTextPopup, AppPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppTextPopup )
