...
/* Forward declaration of the class App::Settings */
#ifndef _AppSettings_
  EW_DECLARE_CLASS( AppSettings )
#define _AppSettings_
#endif
...
/* Deklaration of class : 'App::Settings' */
EW_DEFINE_FIELDS( AppSettings, CoreGroup )
  ...
  EW_OBJECT  ( OutputDelaysButton, WidgetSetToggleButton )
  EW_OBJECT  ( Resound,         ViewsText )
  EW_OBJECT  ( DelaysText,      ViewsText )
  EW_OBJECT  ( Panel,           ViewsText )
  EW_OBJECT  ( Site,            ViewsText )
  EW_OBJECT  ( Version,         ViewsText )
  EW_OBJECT  ( Panel1,          ViewsText )
  EW_OBJECT  ( Site1,           ViewsText )
  EW_OBJECT  ( Version1,        ViewsText )
  EW_OBJECT  ( OutputOverrideButton, WidgetSetToggleButton )
  EW_OBJECT  ( Text,            ViewsText )
  EW_OBJECT  ( HorzBarSlider,   WidgetSetHorizontalSlider )
  EW_OBJECT  ( Text1,           ViewsText )
  EW_OBJECT  ( HorzBarSlider1,  WidgetSetHorizontalSlider )
  EW_OBJECT  ( Intruder,        ViewsText )
  EW_OBJECT  ( SameZoneButton,  WidgetSetToggleButton )
  EW_OBJECT  ( Daytime,         WidgetSetToggleButton )
  EW_OBJECT  ( NightTime,       WidgetSetToggleButton )
  EW_OBJECT  ( SetupRadio,      WidgetSetPushButton )
  EW_OBJECT  ( SiteChangeEventHandler1, CoreSystemEventHandler )
  EW_OBJECT  ( AccessModeChangeEventHandler2, CoreSystemEventHandler )
  EW_OBJECT  ( AutoSilernce,    ViewsText )
  EW_OBJECT  ( SilenceBarSlider2, WidgetSetHorizontalSlider )
  EW_OBJECT  ( silencetime,     ViewsText )
  EW_OBJECT  ( Text2,           ViewsText )
EW_END_OF_FIELDS( AppSettings )

/* Virtual Method Table (VMT) for the class : 'App::Settings' */
EW_DEFINE_METHODS( AppSettings, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( AppSettings _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( AppSettings _this, XSet aState )
