...
#ifndef _ApplicationTestPopup_H
#define _ApplicationTestPopup_H
...
/* Forward declaration of the class Application::TestPopup */
#ifndef _ApplicationTestPopup_
  EW_DECLARE_CLASS( ApplicationTestPopup )
#define _ApplicationTestPopup_
#endif
...
/* Deklaration of class : 'Application::TestPopup' */
EW_DEFINE_FIELDS( ApplicationTestPopup, ApplicationPopup )
  EW_OBJECT  ( Test,            ApplicationTest )
  EW_OBJECT  ( Cancel,          FlatActionButton )
  EW_OBJECT  ( Proceed,         FlatActionButton )
EW_END_OF_FIELDS( ApplicationTestPopup )

/* Virtual Method Table (VMT) for the class : 'Application::TestPopup' */
EW_DEFINE_METHODS( ApplicationTestPopup, ApplicationPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationTestPopup )
