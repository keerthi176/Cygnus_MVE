...
#ifndef _AppKeypadPopup_H
#define _AppKeypadPopup_H
...
/* Forward declaration of the class App::KeypadPopup */
#ifndef _AppKeypadPopup_
  EW_DECLARE_CLASS( AppKeypadPopup )
#define _AppKeypadPopup_
#endif
...
/* Deklaration of class : 'App::KeypadPopup' */
EW_DEFINE_FIELDS( AppKeypadPopup, AppPopup )
...
EW_DEFINE_METHODS( AppKeypadPopup, AppPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppKeypadPopup )
