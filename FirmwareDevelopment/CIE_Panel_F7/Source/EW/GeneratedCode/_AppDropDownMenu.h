...
#ifndef _AppDropDownMenu_H
#define _AppDropDownMenu_H
...
/* Forward declaration of the class App::DropDownMenu */
#ifndef _AppDropDownMenu_
  EW_DECLARE_CLASS( AppDropDownMenu )
#define _AppDropDownMenu_
#endif
...
/* Deklaration of class : 'App::DropDownMenu' */
EW_DEFINE_FIELDS( AppDropDownMenu, CoreGroup )
  ...
  EW_PROPERTY( itemValue,       XInt32 )
  EW_PROPERTY( numItems,        XUInt8 )
EW_END_OF_FIELDS( AppDropDownMenu )

/* Virtual Method Table (VMT) for the class : 'App::DropDownMenu' */
EW_DEFINE_METHODS( AppDropDownMenu, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( AppDropDownMenu _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( AppDropDownMenu _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppDropDownMenu )
