...
#ifndef _ApplicationSetTimePopup_H
#define _ApplicationSetTimePopup_H
...
/* Forward declaration of the class Application::SetTimePopup */
#ifndef _ApplicationSetTimePopup_
  EW_DECLARE_CLASS( ApplicationSetTimePopup )
#define _ApplicationSetTimePopup_
#endif
...
/* Deklaration of class : 'Application::SetTimePopup' */
EW_DEFINE_FIELDS( ApplicationSetTimePopup, ApplicationPopup )
  EW_OBJECT  ( TimePicker,      ApplicationTimePicker )
  EW_OBJECT  ( DatePicker,      ApplicationDatePicker )
  EW_PROPERTY( StartDate,       CoreTime )
  EW_PROPERTY( EndDate,         CoreTime )
  ...
  EW_OBJECT  ( CurrentRadioButton, WidgetSetRadioButton )
  EW_OBJECT  ( StartRadioButton, WidgetSetRadioButton )
  EW_OBJECT  ( EndRadioButton,  WidgetSetRadioButton )
EW_END_OF_FIELDS( ApplicationSetTimePopup )

/* Virtual Method Table (VMT) for the class : 'Application::SetTimePopup' */
EW_DEFINE_METHODS( ApplicationSetTimePopup, ApplicationPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationSetTimePopup )
...
#endif /* _ApplicationSetTimePopup_H */
