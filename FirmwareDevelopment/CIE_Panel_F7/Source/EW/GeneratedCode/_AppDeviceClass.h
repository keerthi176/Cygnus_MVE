...
EW_DEFINE_FIELDS( AppDeviceClass, TemplatesDeviceClass )
  ...
  EW_OBJECT  ( GotoPriorityDisplay, CoreSystemEvent )
...
/* This method is intended to be called by the device to notify the GUI application 
   about a particular system event. */
void AppDeviceClass_TriggerFaultListChangeEvent( AppDeviceClass _this, XBool jumpToPage );

/* Wrapper function for the non virtual method : 'App::DeviceClass.TriggerFaultListChangeEvent()' */
void AppDeviceClass__TriggerFaultListChangeEvent( void* _this, XBool jumpToPage );
...
/* This method is intended to be called by the device to notify the GUI application 
   about a particular system event. */
void AppDeviceClass_TriggerGotoPriorityDisplay( AppDeviceClass _this );

/* Wrapper function for the non virtual method : 'App::DeviceClass.TriggerGotoPriorityDisplay()' */
void AppDeviceClass__TriggerGotoPriorityDisplay( void* _this );

/* The following define announces the presence of the method App::DeviceClass.TriggerGotoPriorityDisplay(). */
#define _AppDeviceClass__TriggerGotoPriorityDisplay_
