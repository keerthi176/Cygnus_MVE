...
#ifndef _AppDisableZoneItem_H
#define _AppDisableZoneItem_H
...
/* Forward declaration of the class App::DisableZoneItem */
#ifndef _AppDisableZoneItem_
  EW_DECLARE_CLASS( AppDisableZoneItem )
#define _AppDisableZoneItem_
#endif
...
/* Deklaration of class : 'App::DisableZoneItem' */
EW_DEFINE_FIELDS( AppDisableZoneItem, CoreGroup )
...
EW_END_OF_FIELDS( AppDisableZoneItem )

/* Virtual Method Table (VMT) for the class : 'App::DisableZoneItem' */
EW_DEFINE_METHODS( AppDisableZoneItem, CoreGroup )
  ...
  EW_METHOD( UpdateViewState,   void )( AppDisableZoneItem _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppDisableZoneItem )
