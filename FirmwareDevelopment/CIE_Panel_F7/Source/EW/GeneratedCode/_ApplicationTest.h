...
#ifndef _ApplicationTest_H
#define _ApplicationTest_H
...
/* Forward declaration of the class Application::Test */
#ifndef _ApplicationTest_
  EW_DECLARE_CLASS( ApplicationTest )
#define _ApplicationTest_
#endif
...
/* Deklaration of class : 'Application::Test' */
EW_DEFINE_FIELDS( ApplicationTest, CoreGroup )
  EW_OBJECT  ( PushButton,      WidgetSetPushButton )
  EW_OBJECT  ( PushButton1,     WidgetSetPushButton )
  EW_OBJECT  ( TreeView,        ApplicationTreeView )
EW_END_OF_FIELDS( ApplicationTest )

/* Virtual Method Table (VMT) for the class : 'Application::Test' */
EW_DEFINE_METHODS( ApplicationTest, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationTest _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationTest _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationTest )
