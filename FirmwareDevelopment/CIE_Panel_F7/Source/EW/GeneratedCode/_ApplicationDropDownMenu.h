...
#ifndef _ApplicationDropDownMenu_H
#define _ApplicationDropDownMenu_H
...
/* Forward declaration of the class Application::DropDownMenu */
#ifndef _ApplicationDropDownMenu_
  EW_DECLARE_CLASS( ApplicationDropDownMenu )
#define _ApplicationDropDownMenu_
#endif
...
/* Deklaration of class : 'Application::DropDownMenu' */
EW_DEFINE_FIELDS( ApplicationDropDownMenu, CoreGroup )
  EW_OBJECT  ( Rectangle,       ViewsRectangle )
  EW_OBJECT  ( Bevel,           ViewsBevel )
  EW_OBJECT  ( SimpleTouchHandler, CoreSimpleTouchHandler )
  EW_OBJECT  ( MenuSelectionText, ViewsText )
...
EW_END_OF_FIELDS( ApplicationDropDownMenu )

/* Virtual Method Table (VMT) for the class : 'Application::DropDownMenu' */
EW_DEFINE_METHODS( ApplicationDropDownMenu, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationDropDownMenu _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationDropDownMenu _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationDropDownMenu )
...
#endif /* _ApplicationDropDownMenu_H */
