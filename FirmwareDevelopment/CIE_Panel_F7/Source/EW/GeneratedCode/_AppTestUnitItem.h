...
#ifndef _AppTestUnitItem_H
#define _AppTestUnitItem_H
...
/* Forward declaration of the class App::TestUnitItem */
#ifndef _AppTestUnitItem_
  EW_DECLARE_CLASS( AppTestUnitItem )
#define _AppTestUnitItem_
#endif
...
/* Deklaration of class : 'App::TestUnitItem' */
EW_DEFINE_FIELDS( AppTestUnitItem, CoreGroup )
...
EW_END_OF_FIELDS( AppTestUnitItem )

/* Virtual Method Table (VMT) for the class : 'App::TestUnitItem' */
EW_DEFINE_METHODS( AppTestUnitItem, CoreGroup )
  ...
  EW_METHOD( UpdateViewState,   void )( AppTestUnitItem _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppTestUnitItem )
...
/* 'C' function for method : 'App::TestUnitItem.ResetFaults()' */
void AppTestUnitItem_ResetFaults( AppTestUnitItem _this, XObject sender );

#ifdef __cplusplus
  }
#endif

#endif /* _AppTestUnitItem_H */
