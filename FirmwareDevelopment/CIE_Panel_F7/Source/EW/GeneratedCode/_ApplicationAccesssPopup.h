...
#ifndef _ApplicationAccesssPopup_H
#define _ApplicationAccesssPopup_H
...
/* Forward declaration of the class Application::AccesssPopup */
#ifndef _ApplicationAccesssPopup_
  EW_DECLARE_CLASS( ApplicationAccesssPopup )
#define _ApplicationAccesssPopup_
#endif
...
/* Deklaration of class : 'Application::AccesssPopup' */
EW_DEFINE_FIELDS( ApplicationAccesssPopup, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationAccesssPopup )

/* Virtual Method Table (VMT) for the class : 'Application::AccesssPopup' */
EW_DEFINE_METHODS( ApplicationAccesssPopup, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationAccesssPopup _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationAccesssPopup _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationAccesssPopup )
...
#endif /* _ApplicationAccesssPopup_H */
