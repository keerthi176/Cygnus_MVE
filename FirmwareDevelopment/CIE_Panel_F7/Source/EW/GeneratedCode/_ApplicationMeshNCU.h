...
#ifndef _ApplicationMeshNCU_H
#define _ApplicationMeshNCU_H
...
/* Forward declaration of the class Application::MeshNCU */
#ifndef _ApplicationMeshNCU_
  EW_DECLARE_CLASS( ApplicationMeshNCU )
#define _ApplicationMeshNCU_
#endif
...
/* Deklaration of class : 'Application::MeshNCU' */
EW_DEFINE_FIELDS( ApplicationMeshNCU, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationMeshNCU )

/* Virtual Method Table (VMT) for the class : 'Application::MeshNCU' */
EW_DEFINE_METHODS( ApplicationMeshNCU, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationMeshNCU _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationMeshNCU _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationMeshNCU )
