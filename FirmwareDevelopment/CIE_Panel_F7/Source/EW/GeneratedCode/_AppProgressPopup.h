...
#ifndef _AppProgressPopup_H
#define _AppProgressPopup_H
...
/* Forward declaration of the class App::ProgressPopup */
#ifndef _AppProgressPopup_
  EW_DECLARE_CLASS( AppProgressPopup )
#define _AppProgressPopup_
#endif
...
EW_DEFINE_METHODS( AppProgressPopup, AppPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppProgressPopup )
