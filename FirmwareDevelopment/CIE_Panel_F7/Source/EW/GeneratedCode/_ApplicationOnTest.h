...
#ifndef _ApplicationOnTest_H
#define _ApplicationOnTest_H
...
/* Forward declaration of the class Application::OnTest */
#ifndef _ApplicationOnTest_
  EW_DECLARE_CLASS( ApplicationOnTest )
#define _ApplicationOnTest_
#endif
...
/* Deklaration of class : 'Application::OnTest' */
EW_DEFINE_FIELDS( ApplicationOnTest, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationOnTest )

/* Virtual Method Table (VMT) for the class : 'Application::OnTest' */
EW_DEFINE_METHODS( ApplicationOnTest, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationOnTest _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationOnTest _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationOnTest )
