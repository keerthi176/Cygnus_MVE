...
#ifndef _ApplicationOutputDelays_H
#define _ApplicationOutputDelays_H
...
/* Forward declaration of the class Application::OutputDelays */
#ifndef _ApplicationOutputDelays_
  EW_DECLARE_CLASS( ApplicationOutputDelays )
#define _ApplicationOutputDelays_
#endif
...
/* Deklaration of class : 'Application::OutputDelays' */
EW_DEFINE_FIELDS( ApplicationOutputDelays, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationOutputDelays )

/* Virtual Method Table (VMT) for the class : 'Application::OutputDelays' */
EW_DEFINE_METHODS( ApplicationOutputDelays, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationOutputDelays )
...
#endif /* _ApplicationOutputDelays_H */
