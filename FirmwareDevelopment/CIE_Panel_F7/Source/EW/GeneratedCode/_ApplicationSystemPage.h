...
#ifndef _ApplicationSystemPage_H
#define _ApplicationSystemPage_H
...
/* Forward declaration of the class Application::SystemPage */
#ifndef _ApplicationSystemPage_
  EW_DECLARE_CLASS( ApplicationSystemPage )
#define _ApplicationSystemPage_
#endif
...
/* Deklaration of class : 'Application::SystemPage' */
EW_DEFINE_FIELDS( ApplicationSystemPage, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationSystemPage )

/* Virtual Method Table (VMT) for the class : 'Application::SystemPage' */
EW_DEFINE_METHODS( ApplicationSystemPage, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationSystemPage _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationSystemPage _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationSystemPage )
...
#endif /* _ApplicationSystemPage_H */
