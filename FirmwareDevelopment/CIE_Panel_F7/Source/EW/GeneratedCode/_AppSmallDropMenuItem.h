...
#ifndef _AppSmallDropMenuItem_H
#define _AppSmallDropMenuItem_H
...
/* Forward declaration of the class App::SmallDropMenuItem */
#ifndef _AppSmallDropMenuItem_
  EW_DECLARE_CLASS( AppSmallDropMenuItem )
#define _AppSmallDropMenuItem_
#endif
...
/* Deklaration of class : 'App::SmallDropMenuItem' */
EW_DEFINE_FIELDS( AppSmallDropMenuItem, CoreGroup )
...
EW_END_OF_FIELDS( AppSmallDropMenuItem )

/* Virtual Method Table (VMT) for the class : 'App::SmallDropMenuItem' */
EW_DEFINE_METHODS( AppSmallDropMenuItem, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( AppSmallDropMenuItem _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( AppSmallDropMenuItem _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppSmallDropMenuItem )
