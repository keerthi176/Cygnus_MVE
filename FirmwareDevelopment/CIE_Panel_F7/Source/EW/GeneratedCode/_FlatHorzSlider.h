...
#ifndef _FlatHorzSlider_H
#define _FlatHorzSlider_H
...
/* Forward declaration of the class Flat::HorzSlider */
#ifndef _FlatHorzSlider_
  EW_DECLARE_CLASS( FlatHorzSlider )
#define _FlatHorzSlider_
#endif
...
EW_DEFINE_FIELDS( FlatHorzSlider, CoreGroup )
...
EW_END_OF_FIELDS( FlatHorzSlider )

/* Virtual Method Table (VMT) for the class : 'Flat::HorzSlider' */
EW_DEFINE_METHODS( FlatHorzSlider, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( FlatHorzSlider _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( FlatHorzSlider _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( FlatHorzSlider )
