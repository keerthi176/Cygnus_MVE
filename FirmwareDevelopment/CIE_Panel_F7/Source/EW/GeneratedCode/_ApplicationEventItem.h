...
#ifndef _ApplicationEventItem_H
#define _ApplicationEventItem_H
...
/* Forward declaration of the class Application::EventItem */
#ifndef _ApplicationEventItem_
  EW_DECLARE_CLASS( ApplicationEventItem )
#define _ApplicationEventItem_
#endif
...
/* Deklaration of class : 'Application::EventItem' */
EW_DEFINE_FIELDS( ApplicationEventItem, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationEventItem )

/* Virtual Method Table (VMT) for the class : 'Application::EventItem' */
EW_DEFINE_METHODS( ApplicationEventItem, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationEventItem _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationEventItem _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationEventItem )
