...
#ifndef _ApplicationDynamicAreaHead_H
#define _ApplicationDynamicAreaHead_H
...
/* Forward declaration of the class Application::DynamicAreaHead */
#ifndef _ApplicationDynamicAreaHead_
  EW_DECLARE_CLASS( ApplicationDynamicAreaHead )
#define _ApplicationDynamicAreaHead_
#endif
...
/* Deklaration of class : 'Application::DynamicAreaHead' */
EW_DEFINE_FIELDS( ApplicationDynamicAreaHead, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationDynamicAreaHead )

/* Virtual Method Table (VMT) for the class : 'Application::DynamicAreaHead' */
EW_DEFINE_METHODS( ApplicationDynamicAreaHead, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationDynamicAreaHead _this, XPoint 
    aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationDynamicAreaHead _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationDynamicAreaHead )
...
#endif /* _ApplicationDynamicAreaHead_H */
