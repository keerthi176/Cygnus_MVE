...
#ifndef _ApplicationFaults_H
#define _ApplicationFaults_H
...
/* Forward declaration of the class Application::Faults */
#ifndef _ApplicationFaults_
  EW_DECLARE_CLASS( ApplicationFaults )
#define _ApplicationFaults_
#endif
...
/* Deklaration of class : 'Application::Faults' */
EW_DEFINE_FIELDS( ApplicationFaults, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationFaults )

/* Virtual Method Table (VMT) for the class : 'Application::Faults' */
EW_DEFINE_METHODS( ApplicationFaults, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationFaults _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationFaults _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationFaults )
