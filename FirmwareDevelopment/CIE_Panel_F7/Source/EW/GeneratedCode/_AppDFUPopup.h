...
#ifndef _AppDFUPopup_H
#define _AppDFUPopup_H
...
/* Forward declaration of the class App::DFUPopup */
#ifndef _AppDFUPopup_
  EW_DECLARE_CLASS( AppDFUPopup )
#define _AppDFUPopup_
#endif
...
/* Deklaration of class : 'App::DFUPopup' */
EW_DEFINE_FIELDS( AppDFUPopup, AppPopup )
...
EW_END_OF_FIELDS( AppDFUPopup )

/* Virtual Method Table (VMT) for the class : 'App::DFUPopup' */
EW_DEFINE_METHODS( AppDFUPopup, AppPopup )
