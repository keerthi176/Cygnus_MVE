...
#ifndef _ApplicationImportConfigPopup_H
#define _ApplicationImportConfigPopup_H
...
/* Forward declaration of the class Application::ImportConfigPopup */
#ifndef _ApplicationImportConfigPopup_
  EW_DECLARE_CLASS( ApplicationImportConfigPopup )
#define _ApplicationImportConfigPopup_
#endif
...
/* Deklaration of class : 'Application::ImportConfigPopup' */
EW_DEFINE_FIELDS( ApplicationImportConfigPopup, ApplicationPopup )
...
EW_END_OF_FIELDS( ApplicationImportConfigPopup )

/* Virtual Method Table (VMT) for the class : 'Application::ImportConfigPopup' */
EW_DEFINE_METHODS( ApplicationImportConfigPopup, ApplicationPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationImportConfigPopup )
...
#endif /* _ApplicationImportConfigPopup_H */
