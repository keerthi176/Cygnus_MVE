...
#ifndef _AppUpdateDevicePopup_H
#define _AppUpdateDevicePopup_H
...
/* Deklaration of class : 'App::UpdateDevicePopup' */
EW_DEFINE_FIELDS( AppUpdateDevicePopup, AppPopup )
  EW_OBJECT  ( HorizontalValueBar, WidgetSetHorizontalValueBar )
  EW_OBJECT  ( Text,            ViewsText )
  EW_OBJECT  ( PushButton,      WidgetSetPushButton )
  EW_OBJECT  ( ProgressHandler, CoreSystemEventHandler )
EW_END_OF_FIELDS( AppUpdateDevicePopup )

/* Virtual Method Table (VMT) for the class : 'App::UpdateDevicePopup' */
EW_DEFINE_METHODS( AppUpdateDevicePopup, AppPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppUpdateDevicePopup )
...
/* 'C' function for method : 'App::UpdateDevicePopup.SetConfigTrue()' */
void AppUpdateDevicePopup_SetConfigTrue( AppUpdateDevicePopup _this, XObject sender );

/* 'C' function for method : 'App::UpdateDevicePopup.SetConfigFalse()' */
void AppUpdateDevicePopup_SetConfigFalse( AppUpdateDevicePopup _this, XObject sender );

#ifdef __cplusplus
  }
#endif

#endif /* _AppUpdateDevicePopup_H */
