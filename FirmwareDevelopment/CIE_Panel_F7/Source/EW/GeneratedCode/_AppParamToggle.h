...
#ifndef _AppParamToggle_H
#define _AppParamToggle_H
...
/* Forward declaration of the class App::ParamToggle */
#ifndef _AppParamToggle_
  EW_DECLARE_CLASS( AppParamToggle )
#define _AppParamToggle_
#endif
...
EW_DEFINE_METHODS( AppParamToggle, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppParamToggle )
