...
#ifndef _ApplicationTextPopup_H
#define _ApplicationTextPopup_H
...
/* Forward declaration of the class Application::TextPopup */
#ifndef _ApplicationTextPopup_
  EW_DECLARE_CLASS( ApplicationTextPopup )
#define _ApplicationTextPopup_
#endif
...
/* Deklaration of class : 'Application::TextPopup' */
EW_DEFINE_FIELDS( ApplicationTextPopup, ApplicationPopup )
...
EW_END_OF_FIELDS( ApplicationTextPopup )

/* Virtual Method Table (VMT) for the class : 'Application::TextPopup' */
EW_DEFINE_METHODS( ApplicationTextPopup, ApplicationPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationTextPopup )
