...
XInt32 CoreGroup_GetIndexOfView( CoreGroup _this, CoreView aView );

/* Wrapper function for the virtual method : 'Core::Group.GetIndexOfView()' */
XInt32 CoreGroup__GetIndexOfView( void* _this, CoreView aView );
