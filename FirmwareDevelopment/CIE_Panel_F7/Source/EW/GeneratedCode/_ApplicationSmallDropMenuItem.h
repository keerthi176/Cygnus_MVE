...
#ifndef _ApplicationSmallDropMenuItem_H
#define _ApplicationSmallDropMenuItem_H
...
/* Forward declaration of the class Application::SmallDropMenuItem */
#ifndef _ApplicationSmallDropMenuItem_
  EW_DECLARE_CLASS( ApplicationSmallDropMenuItem )
#define _ApplicationSmallDropMenuItem_
#endif
...
/* Deklaration of class : 'Application::SmallDropMenuItem' */
EW_DEFINE_FIELDS( ApplicationSmallDropMenuItem, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationSmallDropMenuItem )

/* Virtual Method Table (VMT) for the class : 'Application::SmallDropMenuItem' */
EW_DEFINE_METHODS( ApplicationSmallDropMenuItem, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationSmallDropMenuItem _this, XPoint 
    aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationSmallDropMenuItem _this, XSet 
    aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationSmallDropMenuItem )
...
#endif /* _ApplicationSmallDropMenuItem_H */
