...
#ifndef _FlatRadioButton_H
#define _FlatRadioButton_H
...
/* Forward declaration of the class Flat::RadioButton */
#ifndef _FlatRadioButton_
  EW_DECLARE_CLASS( FlatRadioButton )
#define _FlatRadioButton_
#endif
...
/* Radio button widget with a flat design. The widget is used to choose an option 
   (= a concrete value) out of several possibilities. */
EW_DEFINE_FIELDS( FlatRadioButton, CoreGroup )
  EW_PROPERTY( OnChange,        XSlot )
  EW_OBJECT  ( TouchHandler,    CoreSimpleTouchHandler )
  EW_OBJECT  ( BoxImage,        ViewsImage )
  EW_OBJECT  ( RadioImage,      ViewsImage )
...
EW_END_OF_FIELDS( FlatRadioButton )

/* Virtual Method Table (VMT) for the class : 'Flat::RadioButton' */
EW_DEFINE_METHODS( FlatRadioButton, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( FlatRadioButton _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( FlatRadioButton _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( FlatRadioButton )
