...
EW_DEFINE_METHODS( CoreVerticalList, CoreGroup )
  ...
  EW_METHOD( GetIndexOfView,    XInt32 )( CoreVerticalList _this, CoreView aView )
  EW_METHOD( GetViewAtIndex,    CoreView )( CoreVerticalList _this, XInt32 aIndex )
...
/* The method GetIndexOfView() returns the Z-order position of the view determined 
   by the parameter aView. The view lying in the background of the component has 
   the index 0. The next above view has the index 1, and so far. The total number 
   of views enclosed within this component can be asked by the method @CountViews().
   If the method has been invoked with 'null' as parameter, or the view doesn't 
   belong to this component, the method returns the negative index -1. */
XInt32 CoreVerticalList_GetIndexOfView( CoreVerticalList _this, CoreView aView );
