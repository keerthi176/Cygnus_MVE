...
#ifndef _AppConfirmPopup_H
#define _AppConfirmPopup_H
...
/* Forward declaration of the class App::ConfirmPopup */
#ifndef _AppConfirmPopup_
  EW_DECLARE_CLASS( AppConfirmPopup )
#define _AppConfirmPopup_
#endif
...
/* Deklaration of class : 'App::ConfirmPopup' */
EW_DEFINE_FIELDS( AppConfirmPopup, AppPopup )
...
EW_END_OF_FIELDS( AppConfirmPopup )

/* Virtual Method Table (VMT) for the class : 'App::ConfirmPopup' */
EW_DEFINE_METHODS( AppConfirmPopup, AppPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppConfirmPopup )
