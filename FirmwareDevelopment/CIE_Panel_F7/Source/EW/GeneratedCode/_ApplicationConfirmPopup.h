...
#ifndef _ApplicationConfirmPopup_H
#define _ApplicationConfirmPopup_H
...
/* Forward declaration of the class Application::ConfirmPopup */
#ifndef _ApplicationConfirmPopup_
  EW_DECLARE_CLASS( ApplicationConfirmPopup )
#define _ApplicationConfirmPopup_
#endif
...
/* Deklaration of class : 'Application::ConfirmPopup' */
EW_DEFINE_FIELDS( ApplicationConfirmPopup, ApplicationPopup )
  EW_OBJECT  ( Text1,           ViewsText )
  EW_VARIABLE( meth,            XSlot )
  EW_OBJECT  ( PushButton,      WidgetSetPushButton )
  EW_OBJECT  ( PushButton1,     WidgetSetPushButton )
EW_END_OF_FIELDS( ApplicationConfirmPopup )

/* Virtual Method Table (VMT) for the class : 'Application::ConfirmPopup' */
EW_DEFINE_METHODS( ApplicationConfirmPopup, ApplicationPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationConfirmPopup )
...
#endif /* _ApplicationConfirmPopup_H */
