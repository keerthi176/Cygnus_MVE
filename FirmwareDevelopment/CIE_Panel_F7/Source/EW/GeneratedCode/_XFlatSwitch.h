...
#ifndef _XFlatSwitch_H
#define _XFlatSwitch_H
...
/* Forward declaration of the class XFlat::Switch */
#ifndef _XFlatSwitch_
  EW_DECLARE_CLASS( XFlatSwitch )
#define _XFlatSwitch_
#endif


/* Simple switch widget to switch a boolean value on and off. The appearance is 
   similar to a switch with on/off position. */
EW_DEFINE_FIELDS( XFlatSwitch, CoreGroup )
  ...
  EW_OBJECT  ( Button,          ViewsImage )
  EW_PROPERTY( ButtonImage,     ResourcesBitmap )
  EW_PROPERTY( Active,          XBool )
EW_END_OF_FIELDS( XFlatSwitch )

/* Virtual Method Table (VMT) for the class : 'XFlat::Switch' */
EW_DEFINE_METHODS( XFlatSwitch, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( XFlatSwitch _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( XFlatSwitch _this, XSet aState )
