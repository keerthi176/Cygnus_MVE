...
#ifndef _AppAccesssPopup_H
#define _AppAccesssPopup_H
...
/* Forward declaration of the class App::AccesssPopup */
#ifndef _AppAccesssPopup_
  EW_DECLARE_CLASS( AppAccesssPopup )
#define _AppAccesssPopup_
#endif
...
/* Deklaration of class : 'App::AccesssPopup' */
EW_DEFINE_FIELDS( AppAccesssPopup, CoreGroup )
...
EW_END_OF_FIELDS( AppAccesssPopup )

/* Virtual Method Table (VMT) for the class : 'App::AccesssPopup' */
EW_DEFINE_METHODS( AppAccesssPopup, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( AppAccesssPopup _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( AppAccesssPopup _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppAccesssPopup )
