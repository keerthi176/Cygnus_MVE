...
#ifndef _ApplicationButton_H
#define _ApplicationButton_H
...
/* Forward declaration of the class Application::Button */
#ifndef _ApplicationButton_
  EW_DECLARE_CLASS( ApplicationButton )
#define _ApplicationButton_
#endif
...
/* Deklaration of class : 'Application::Button' */
EW_DEFINE_FIELDS( ApplicationButton, CoreGroup )
  EW_OBJECT  ( FillPath,        ViewsFillPath )
  EW_OBJECT  ( Image,           ViewsImage )
  EW_PROPERTY( Icon,            ResourcesBitmap )
  EW_PROPERTY( ButtonText,      XString )
...
EW_END_OF_FIELDS( ApplicationButton )

/* Virtual Method Table (VMT) for the class : 'Application::Button' */
EW_DEFINE_METHODS( ApplicationButton, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationButton _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationButton _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationButton )
