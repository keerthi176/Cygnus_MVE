...
#ifndef _ApplicationWritable_H
#define _ApplicationWritable_H
...
/* Forward declaration of the class Application::Writable */
#ifndef _ApplicationWritable_
  EW_DECLARE_CLASS( ApplicationWritable )
#define _ApplicationWritable_
#endif
...
/* Deklaration of class : 'Application::Writable' */
EW_DEFINE_FIELDS( ApplicationWritable, CoreGroup )
  EW_OBJECT  ( Bevel,           ViewsBevel )
  EW_OBJECT  ( Rectangle9,      ViewsRectangle )
  EW_OBJECT  ( TextEditor,      ApplicationTextEditor )
  EW_PROPERTY( Property,        XRef )
  EW_PROPERTY( MaxLength,       XInt32 )
EW_END_OF_FIELDS( ApplicationWritable )

/* Virtual Method Table (VMT) for the class : 'Application::Writable' */
EW_DEFINE_METHODS( ApplicationWritable, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationWritable _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationWritable _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationWritable )
