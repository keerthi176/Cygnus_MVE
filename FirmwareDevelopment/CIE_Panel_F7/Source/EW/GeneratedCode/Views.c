...
/* 'C' function for method : 'Views::Image.OnGetColor()' */
XColor ViewsImage_OnGetColor( ViewsImage _this )
{
...
/* 'C' function for method : 'Views::Wallpaper.OnGetVisible()' */
XBool ViewsWallpaper_OnGetVisible( ViewsWallpaper _this )
{
  return (( _this->Super2.viewState & CoreViewStateVisible ) == CoreViewStateVisible 
    );
}

/* 'C' function for method : 'Views::Wallpaper.OnSetVisible()' */
void ViewsWallpaper_OnSetVisible( ViewsWallpaper _this, XBool value )
{
  if ( value )
    CoreView__ChangeViewState( _this, CoreViewStateVisible, 0 );
  else
...
void ViewsAttrText_OnSetWrapWidth( ViewsAttrText _this, XInt32 value )
{
  ...
  if (( value == 0 ) || ( _this->OnUpdate.Object != 0 ))
    _this->Super2.viewState = _this->Super2.viewState & ~CoreViewStateFastReshape;
  else
    _this->Super2.viewState = _this->Super2.viewState | CoreViewStateFastReshape;
}
...
/* Garbage Collector method for the class 'Views::FillPath' */
void ViewsFillPath__Mark( ViewsFillPath _this )
{
  ...
  XPoint aOffset, XInt32 aOpacity, XBool aBlend )
{
  ...
  else
  {
    ...
    0, EwMoveRectPos( _this->Super1.Bounds, aOffset ), _Const0004, ctl, ctr, cbr, 
    cbl, 1 );
...
/* 'C' function for method : 'Views::FillPath.OnSetQuality()' */
void ViewsFillPath_OnSetQuality( ViewsFillPath _this, XBool value )
{
  if ( value == _this->Quality )
    return;
...
EW_DEFINE_CLASS( ViewsFillPath, CoreRectView, "Views::FillPath" )
  CoreRectView_initLayoutContext,
  CoreView_GetRoot,
  ViewsFillPath_Draw,
  CoreView_HandleEvent,
...
/* 'C' function for method : 'Views::StrokePath.OnSetQuality()' */
