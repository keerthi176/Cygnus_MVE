...
#ifndef _ApplicationDisableZoneItem_H
#define _ApplicationDisableZoneItem_H
...
/* Forward declaration of the class Application::DisableZoneItem */
#ifndef _ApplicationDisableZoneItem_
  EW_DECLARE_CLASS( ApplicationDisableZoneItem )
#define _ApplicationDisableZoneItem_
#endif
...
/* Deklaration of class : 'Application::DisableZoneItem' */
EW_DEFINE_FIELDS( ApplicationDisableZoneItem, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationDisableZoneItem )

/* Virtual Method Table (VMT) for the class : 'Application::DisableZoneItem' */
EW_DEFINE_METHODS( ApplicationDisableZoneItem, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationDisableZoneItem _this, XPoint 
    aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationDisableZoneItem _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationDisableZoneItem )
...
#endif /* _ApplicationDisableZoneItem_H */
