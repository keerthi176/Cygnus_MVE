...
/* The class Views::Image provides a kind of view specialized to draw and animate 
   ...
   by the property @Alignment. The properties @Color, @ColorTL, @ColorTR, @ColorBL 
   and @ColorBR can be used to tint the bitmap or to modulate its transparency. 
   For each view's corner different color can be set, so the bitmap can be shown 
   ...
   - In case of Native or Index8 bitmaps the opacity of the bitmap is modulated 
