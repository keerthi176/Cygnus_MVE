...
#ifndef _ApplicationModify_H
#define _ApplicationModify_H
...
/* Forward declaration of the class Application::Modify */
#ifndef _ApplicationModify_
  EW_DECLARE_CLASS( ApplicationModify )
#define _ApplicationModify_
#endif
...
/* Deklaration of class : 'Application::Modify' */
EW_DEFINE_FIELDS( ApplicationModify, CoreGroup )
  ...
  EW_ARRAY   ( zoneExpanded,    XBool, [97])
EW_END_OF_FIELDS( ApplicationModify )

/* Virtual Method Table (VMT) for the class : 'Application::Modify' */
EW_DEFINE_METHODS( ApplicationModify, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationModify _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationModify _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationModify )
