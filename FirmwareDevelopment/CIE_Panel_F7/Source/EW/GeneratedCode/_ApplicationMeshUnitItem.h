...
#ifndef _ApplicationMeshUnitItem_H
#define _ApplicationMeshUnitItem_H
...
/* Deklaration of class : 'Application::MeshUnitItem' */
EW_DEFINE_FIELDS( ApplicationMeshUnitItem, CoreGroup )
  EW_OBJECT  ( MeshUnit,        ApplicationMeshUnit )
  EW_OBJECT  ( MeshNCU,         ApplicationMeshNCU )
EW_END_OF_FIELDS( ApplicationMeshUnitItem )

/* Virtual Method Table (VMT) for the class : 'Application::MeshUnitItem' */
EW_DEFINE_METHODS( ApplicationMeshUnitItem, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationMeshUnitItem _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationMeshUnitItem _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationMeshUnitItem )
...
#endif /* _ApplicationMeshUnitItem_H */
