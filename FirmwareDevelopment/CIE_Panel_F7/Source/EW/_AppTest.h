...
/* Forward declaration of the class App::Test */
#ifndef _AppTest_
  EW_DECLARE_CLASS( AppTest )
#define _AppTest_
#endif
...
/* Deklaration of class : 'App::Test' */
EW_DEFINE_FIELDS( AppTest, CoreGroup )
  EW_OBJECT  ( PushButton,      WidgetSetPushButton )
  EW_OBJECT  ( PushButton1,     WidgetSetPushButton )
  EW_OBJECT  ( TreeView,        AppTreeView )
  ...
  EW_PROPERTY( Tone,            XInt32 )
  EW_OBJECT  ( PropertyObserver, CorePropertyObserver )
  EW_OBJECT  ( ToggleEverything, WidgetSetToggleButton )
...
EW_END_OF_FIELDS( AppTest )

/* Virtual Method Table (VMT) for the class : 'App::Test' */
EW_DEFINE_METHODS( AppTest, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( AppTest _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( AppTest _this, XSet aState )
...
/* 'C' function for method : 'App::Test.ShowLog()' */
void AppTest_ShowLog( AppTest _this, XObject sender );
