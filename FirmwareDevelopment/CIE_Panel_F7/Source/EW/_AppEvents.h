...
/* Forward declaration of the class App::Events */
#ifndef _AppEvents_
  EW_DECLARE_CLASS( AppEvents )
#define _AppEvents_
#endif
...
/* Deklaration of class : 'App::Events' */
EW_DEFINE_FIELDS( AppEvents, CoreGroup )
  EW_OBJECT  ( EventListChangeHandler, CoreSystemEventHandler )
  EW_OBJECT  ( ListViewer,      AppListViewer )
  EW_OBJECT  ( ResoundAlarmsButton1, WidgetSetPushButton )
  EW_OBJECT  ( ConfirmEventButton, WidgetSetPushButton )
  EW_OBJECT  ( AcknowledgeEventButton, WidgetSetPushButton )
  EW_OBJECT  ( SwitchConfirmEventEvent, CoreSystemEventHandler )
  EW_OBJECT  ( SwitchAcknowledgeEventEvent, CoreSystemEventHandler )
  EW_OBJECT  ( SiteChangeEventHandler, CoreSystemEventHandler )
  EW_OBJECT  ( ResoundStateEventHandler, CoreSystemEventHandler )
EW_END_OF_FIELDS( AppEvents )

/* Virtual Method Table (VMT) for the class : 'App::Events' */
EW_DEFINE_METHODS( AppEvents, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( AppEvents _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( AppEvents _this, XSet aState )
