...
#ifndef _AppRoundBox_H
#define _AppRoundBox_H
...
/* Forward declaration of the class App::RoundBox */
#ifndef _AppRoundBox_
  EW_DECLARE_CLASS( AppRoundBox )
#define _AppRoundBox_
#endif
...
/* Deklaration of class : 'App::RoundBox' */
EW_DEFINE_FIELDS( AppRoundBox, CoreGroup )
...
EW_END_OF_FIELDS( AppRoundBox )

/* Virtual Method Table (VMT) for the class : 'App::RoundBox' */
EW_DEFINE_METHODS( AppRoundBox, CoreGroup )
  ...
  EW_METHOD( UpdateViewState,   void )( AppRoundBox _this, XSet aState )
