...
#ifndef _AppDisable_H
#define _AppDisable_H
...
/* Forward declaration of the class App::Disable */
#ifndef _AppDisable_
  EW_DECLARE_CLASS( AppDisable )
#define _AppDisable_
#endif
...
/* Deklaration of class : 'App::Disable' */
EW_DEFINE_FIELDS( AppDisable, CoreGroup )
  ...
  EW_OBJECT  ( AccessLevelChange, CoreSystemEventHandler )
EW_END_OF_FIELDS( AppDisable )

/* Virtual Method Table (VMT) for the class : 'App::Disable' */
EW_DEFINE_METHODS( AppDisable, CoreGroup )
  ...
  EW_METHOD( OnSetVisible,      void )( AppDisable _this, XBool value )
  EW_METHOD( DispatchEvent,     XObject )( CoreGroup _this, CoreEvent aEvent )
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( CoreGroup _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( AppDisable _this, XSet aState )
