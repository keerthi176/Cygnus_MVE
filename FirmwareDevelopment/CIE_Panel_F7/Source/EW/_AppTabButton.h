...
#ifndef _AppTabButton_H
#define _AppTabButton_H
...
/* Forward declaration of the class App::TabButton */
#ifndef _AppTabButton_
  EW_DECLARE_CLASS( AppTabButton )
#define _AppTabButton_
#endif
...
/* Deklaration of class : 'App::TabButton' */
EW_DEFINE_FIELDS( AppTabButton, CoreGroup )
  EW_OBJECT  ( TabBackground,   ViewsRectangle )
...
EW_END_OF_FIELDS( AppTabButton )

/* Virtual Method Table (VMT) for the class : 'App::TabButton' */
EW_DEFINE_METHODS( AppTabButton, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( AppTabButton _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( AppTabButton _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppTabButton )
