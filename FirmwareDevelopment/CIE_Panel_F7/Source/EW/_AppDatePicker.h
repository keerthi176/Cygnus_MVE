...
#ifndef _AppDatePicker_H
#define _AppDatePicker_H
...
/* Forward declaration of the class App::DatePicker */
#ifndef _AppDatePicker_
  EW_DECLARE_CLASS( AppDatePicker )
#define _AppDatePicker_
#endif
...
EW_DEFINE_FIELDS( AppDatePicker, TemplatesPickerControl )
...
EW_END_OF_FIELDS( AppDatePicker )

/* Virtual Method Table (VMT) for the class : 'App::DatePicker' */
EW_DEFINE_METHODS( AppDatePicker, TemplatesPickerControl )
  ...
  EW_METHOD( UpdateViewState,   void )( AppDatePicker _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppDatePicker )
