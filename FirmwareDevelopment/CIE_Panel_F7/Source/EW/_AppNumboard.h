...
#ifndef _AppNumboard_H
#define _AppNumboard_H
...
/* Forward declaration of the class App::Numboard */
#ifndef _AppNumboard_
  EW_DECLARE_CLASS( AppNumboard )
#define _AppNumboard_
#endif
...
/* Deklaration of class : 'App::Numboard' */
EW_DEFINE_FIELDS( AppNumboard, CoreGroup )
...
EW_DEFINE_METHODS( AppNumboard, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( AppNumboard _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( AppNumboard _this, XSet aState )
...
/* 'C' function for method : 'App::Numboard.HoldSlot()' */
void AppNumboard_HoldSlot( AppNumboard _this, XObject sender );

#ifdef __cplusplus
  }
#endif

#endif /* _AppNumboard_H */
