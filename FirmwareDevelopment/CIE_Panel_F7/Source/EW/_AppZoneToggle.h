...
#ifndef _AppZoneToggle_H
#define _AppZoneToggle_H
...
/* Forward declaration of the class App::ZoneToggle */
#ifndef _AppZoneToggle_
  EW_DECLARE_CLASS( AppZoneToggle )
#define _AppZoneToggle_
#endif
...
/* Deklaration of class : 'App::ZoneToggle' */
EW_DEFINE_FIELDS( AppZoneToggle, CoreGroup )
  ...
  EW_PROPERTY( Dev,             AppDeviceConfig )
  EW_OBJECT  ( Image,           AppChannelImage )
  EW_PROPERTY( UnitNum,         XUInt16 )
  EW_PROPERTY( imagenum,        XUInt8 )
  EW_PROPERTY( isZone,          XBool )
  EW_PROPERTY( isDevice,        XBool )
  EW_PROPERTY( ZoneNum,         XUInt8 )
EW_END_OF_FIELDS( AppZoneToggle )

/* Virtual Method Table (VMT) for the class : 'App::ZoneToggle' */
EW_DEFINE_METHODS( AppZoneToggle, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( AppZoneToggle _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( AppZoneToggle _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppZoneToggle )
