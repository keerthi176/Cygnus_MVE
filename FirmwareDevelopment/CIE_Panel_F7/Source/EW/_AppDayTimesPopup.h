...
#ifndef _AppDayTimesPopup_H
#define _AppDayTimesPopup_H
...
/* Forward declaration of the class App::DayTimesPopup */
#ifndef _AppDayTimesPopup_
  EW_DECLARE_CLASS( AppDayTimesPopup )
#define _AppDayTimesPopup_
#endif
...
/* Deklaration of class : 'App::DayTimesPopup' */
EW_DEFINE_FIELDS( AppDayTimesPopup, AppPopup )
  ...
  EW_OBJECT  ( AccessChangeEventHandler2, CoreSystemEventHandler )
EW_END_OF_FIELDS( AppDayTimesPopup )

/* Virtual Method Table (VMT) for the class : 'App::DayTimesPopup' */
EW_DEFINE_METHODS( AppDayTimesPopup, AppPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppDayTimesPopup )
