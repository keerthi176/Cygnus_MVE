...
#ifndef _AppLEDPopup_H
#define _AppLEDPopup_H
...
/* Forward declaration of the class App::LEDPopup */
#ifndef _AppLEDPopup_
  EW_DECLARE_CLASS( AppLEDPopup )
#define _AppLEDPopup_
#endif
...
/* Deklaration of class : 'App::LEDPopup' */
EW_DEFINE_FIELDS( AppLEDPopup, AppPopup )
  EW_OBJECT  ( PushButton,      WidgetSetPushButton )
  EW_OBJECT  ( Text,            ViewsText )
EW_END_OF_FIELDS( AppLEDPopup )

/* Virtual Method Table (VMT) for the class : 'App::LEDPopup' */
EW_DEFINE_METHODS( AppLEDPopup, AppPopup )
