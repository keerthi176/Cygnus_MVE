...
/* Forward declaration of the class App::Button */
#ifndef _AppButton_
  EW_DECLARE_CLASS( AppButton )
#define _AppButton_
#endif
...
/* Deklaration of class : 'App::Button' */
EW_DEFINE_FIELDS( AppButton, CoreGroup )
...
EW_END_OF_FIELDS( AppButton )

/* Virtual Method Table (VMT) for the class : 'App::Button' */
EW_DEFINE_METHODS( AppButton, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( AppButton _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( AppButton _this, XSet aState )
