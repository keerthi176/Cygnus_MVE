...
#ifndef _AppSystemPage_H
#define _AppSystemPage_H
...
/* Forward declaration of the class App::SystemPage */
#ifndef _AppSystemPage_
  EW_DECLARE_CLASS( AppSystemPage )
#define _AppSystemPage_
#endif
...
/* Deklaration of class : 'App::SystemPage' */
EW_DEFINE_FIELDS( AppSystemPage, CoreGroup )
  EW_OBJECT  ( Rectangle,       ViewsRectangle )
  EW_OBJECT  ( Outline,         CoreOutline )
  EW_OBJECT  ( Bevel,           ViewsBevel )
  EW_OBJECT  ( AttrText,        ViewsAttrText )
  EW_OBJECT  ( AttrText1,       ViewsAttrText )
  ...
  EW_OBJECT  ( HorzSlider,      WidgetSetHorizontalSlider )
  EW_OBJECT  ( PushButton5,     WidgetSetPushButton )
  EW_OBJECT  ( HorizontalValueBarConfig, WidgetSetHorizontalValueBarConfig )
  EW_OBJECT  ( AppSuppEnable,   WidgetSetToggleButton )
  EW_OBJECT  ( SMSEnable,       WidgetSetToggleButton )
  EW_OBJECT  ( PushButton6,     WidgetSetPushButton )
  EW_OBJECT  ( AttrSet1,        GraphicsAttrSet )
  EW_PROPERTY( devs,            XUInt16 )
  EW_PROPERTY( fwversion,       XInt16 )
  EW_PROPERTY( osversion,       XInt16 )
  EW_PROPERTY( leds,            XUInt8 )
  EW_PROPERTY( zones,           XUInt8 )
EW_END_OF_FIELDS( AppSystemPage )

/* Virtual Method Table (VMT) for the class : 'App::SystemPage' */
EW_DEFINE_METHODS( AppSystemPage, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( AppSystemPage _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( AppSystemPage _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppSystemPage )
