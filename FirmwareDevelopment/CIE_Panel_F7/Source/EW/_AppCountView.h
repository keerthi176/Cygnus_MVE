...
#ifndef _AppCountView_H
#define _AppCountView_H
...
/* Forward declaration of the class App::CountView */
#ifndef _AppCountView_
  EW_DECLARE_CLASS( AppCountView )
#define _AppCountView_
#endif
...
/* Deklaration of class : 'App::CountView' */
EW_DEFINE_FIELDS( AppCountView, CoreGroup )
  EW_OBJECT  ( Text,            ViewsText )
  EW_PROPERTY( prefix,          XString )
  EW_PROPERTY( count,           XInt32 )
  EW_PROPERTY( total,           XInt32 )
  EW_OBJECT  ( HorizontalValueBar1, WidgetSetHorizontalValueBar )
  EW_OBJECT  ( Timer,           CoreTimer )
  EW_PROPERTY( dy,              XInt32 )
EW_END_OF_FIELDS( AppCountView )

/* Virtual Method Table (VMT) for the class : 'App::CountView' */
EW_DEFINE_METHODS( AppCountView, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( AppCountView _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( AppCountView _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppCountView )
