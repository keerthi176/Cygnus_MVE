...
#ifndef _AppInputChannels_H
#define _AppInputChannels_H
...
/* Forward declaration of the class App::InputChannels */
#ifndef _AppInputChannels_
  EW_DECLARE_CLASS( AppInputChannels )
#define _AppInputChannels_
#endif
...
/* Deklaration of class : 'App::InputChannels' */
EW_DEFINE_FIELDS( AppInputChannels, AppPopup )
  EW_OBJECT  ( Text1,           ViewsText )
  EW_OBJECT  ( Cancel,          WidgetSetPushButton )
  EW_OBJECT  ( InputAction,     AppInputAction )
  EW_OBJECT  ( DropDownMenu,    AppDropDownMenu )
  EW_OBJECT  ( InputSignal,     AppInputSignal )
  EW_OBJECT  ( InputDelay,      AppInputDelay )
  EW_PROPERTY( ChanIndex,       XInt32 )
  EW_PROPERTY( device,          AppDeviceConfig )
EW_END_OF_FIELDS( AppInputChannels )

/* Virtual Method Table (VMT) for the class : 'App::InputChannels' */
EW_DEFINE_METHODS( AppInputChannels, AppPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppInputChannels )
