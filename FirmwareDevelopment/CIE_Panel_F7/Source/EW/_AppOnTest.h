...
/* Forward declaration of the class App::OnTest */
#ifndef _AppOnTest_
  EW_DECLARE_CLASS( AppOnTest )
#define _AppOnTest_
#endif
...
/* Deklaration of class : 'App::OnTest' */
EW_DEFINE_FIELDS( AppOnTest, CoreGroup )
...
EW_END_OF_FIELDS( AppOnTest )

/* Virtual Method Table (VMT) for the class : 'App::OnTest' */
EW_DEFINE_METHODS( AppOnTest, CoreGroup )
