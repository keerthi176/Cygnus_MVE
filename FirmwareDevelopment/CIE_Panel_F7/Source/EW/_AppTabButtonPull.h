...
#ifndef _AppTabButtonPull_H
#define _AppTabButtonPull_H
...
/* Forward declaration of the class App::MenuItem */
#ifndef _AppMenuItem_
  EW_DECLARE_CLASS( AppMenuItem )
#define _AppMenuItem_
#endif

/* Forward declaration of the class App::TabButtonPull */
#ifndef _AppTabButtonPull_
  EW_DECLARE_CLASS( AppTabButtonPull )
#define _AppTabButtonPull_
#endif
...
/* Deklaration of class : 'App::TabButtonPull' */
EW_DEFINE_FIELDS( AppTabButtonPull, CoreGroup )
  EW_OBJECT  ( TabPullBackground, ViewsRectangle )
  ...
  EW_OBJECT  ( SelectionText,   ViewsText )
...
EW_END_OF_FIELDS( AppTabButtonPull )

/* Virtual Method Table (VMT) for the class : 'App::TabButtonPull' */
EW_DEFINE_METHODS( AppTabButtonPull, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( AppTabButtonPull _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( AppTabButtonPull _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( AppTabButtonPull )
