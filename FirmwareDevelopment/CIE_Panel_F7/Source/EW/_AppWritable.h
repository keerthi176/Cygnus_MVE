...
#ifndef _AppWritable_H
#define _AppWritable_H
...
/* Forward declaration of the class App::Writable */
#ifndef _AppWritable_
  EW_DECLARE_CLASS( AppWritable )
#define _AppWritable_
#endif
...
/* Deklaration of class : 'App::Writable' */
EW_DEFINE_FIELDS( AppWritable, CoreGroup )
  EW_OBJECT  ( Bevel,           ViewsBevel )
  EW_OBJECT  ( Rectangle9,      ViewsRectangle )
  EW_OBJECT  ( TextEditor,      AppTextEditor )
...
EW_END_OF_FIELDS( AppWritable )

/* Virtual Method Table (VMT) for the class : 'App::Writable' */
EW_DEFINE_METHODS( AppWritable, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( AppWritable _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( AppWritable _this, XSet aState )
