...
#ifndef _AppTreeView_H
#define _AppTreeView_H
...
/* Forward declaration of the class App::TreeView */
#ifndef _AppTreeView_
  EW_DECLARE_CLASS( AppTreeView )
#define _AppTreeView_
#endif
...
/* Deklaration of class : 'App::TreeView' */
EW_DEFINE_FIELDS( AppTreeView, CoreGroup )
  ...
  EW_PROPERTY( MenuHandle,      AppSmallDropDownMenuList )
  EW_OBJECT  ( MeshListChangeEventHandler, CoreSystemEventHandler )
EW_END_OF_FIELDS( AppTreeView )

/* Virtual Method Table (VMT) for the class : 'App::TreeView' */
EW_DEFINE_METHODS( AppTreeView, CoreGroup )
  ...
  EW_METHOD( OnSetVisible,      void )( AppTreeView _this, XBool value )
  EW_METHOD( DispatchEvent,     XObject )( CoreGroup _this, CoreEvent aEvent )
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( CoreGroup _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( AppTreeView _this, XSet aState )
