...
/* Forward declaration of the class App::Popup */
#ifndef _AppPopup_
  EW_DECLARE_CLASS( AppPopup )
#define _AppPopup_
#endif
...
/* Deklaration of class : 'App::Popup' */
EW_DEFINE_FIELDS( AppPopup, CoreGroup )
  EW_OBJECT  ( InsideTouchHandler, CoreSimpleTouchHandler )
  ...
  EW_VARIABLE( Dead,            XBool )
EW_END_OF_FIELDS( AppPopup )

/* Virtual Method Table (VMT) for the class : 'App::Popup' */
EW_DEFINE_METHODS( AppPopup, CoreGroup )
