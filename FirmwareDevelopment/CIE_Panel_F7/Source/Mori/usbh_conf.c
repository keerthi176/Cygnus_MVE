...
void HAL_HCD_MspInit(HCD_HandleTypeDef *hHCD)
{
  ...
  /* USER CODE END USB_OTG_HS_MspInit 0 */
    ...
    PB15     ------> USB_OTG_HS_DP 
    */
    GPIO_InitStruct.Pin = USB_HS_HOST_DM_Pin|USB_HS_HOST_DP_Pin;
...
void HAL_HCD_MspDeInit(HCD_HandleTypeDef *hHCD)
{
  ...
  /* USER CODE END USB_OTG_HS_MspDeInit 0 */
    ...
    PB15     ------> USB_OTG_HS_DP 
    */
    HAL_GPIO_DeInit(GPIOB, USB_HS_HOST_DM_Pin|USB_HS_HOST_DP_Pin);
...
USBH_StatusTypeDef  USBH_LL_Init (USBH_HandleTypeDef *phost)
{
	...
	phHCD->Init.Host_channels = 12;
	phHCD->Init.dma_enable = DISABLE;
	phHCD->Init.low_power_enable = DISABLE;
	phHCD->Init.phy_itface = USB_OTG_EMBEDDED_PHY;
	phHCD->Init.Sof_enable = DISABLE;
	phHCD->Init.speed = HCD_SPEED_FULL;
	phHCD->Init.vbus_sensing_enable = DISABLE;
	phHCD->Init.use_external_vbus = DISABLE;
...
HAL_StatusTypeDef USB_StopHostChannel(USB_OTG_GlobalTypeDef *USBx, int i )
{
