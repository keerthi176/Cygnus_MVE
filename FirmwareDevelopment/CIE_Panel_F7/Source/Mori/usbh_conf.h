...
#define USBH_MAX_SIZE_CONFIGURATION           0x300
#define USBH_MAX_DATA_BUFFER                  0x300
...
#define USBH_UsrLog(...)    db(__VA_ARGS__);\
                            db("\n");
#else
#define USBH_UsrLog(...)
#endif
